...
public val FluentIcons.Light.PersonAdd32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Light.PersonAdd32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(-2.686f, -6f, -6f, -6f)
            close()
            moveToRelative(0.375f, 15f)
            horizontalLineTo(7.5f)
            curveTo(5.567f, 18f, 4f, 19.567f, 4f, 21.5f)
            verticalLineToRelative(0.667f)
            curveTo(4f, 24.317f, 6.766f, 30f, 16f, 30f)
            curveToRelative(0.426f, 0f, 0.839f, -0.012f, 1.238f, -0.035f)
            curveToRelative(-0.31f, -0.302f, -0.6f, -0.625f, -0.865f, -0.968f)
            ...
            reflectiveCurveTo(23f, 18.336f, 23f, 18.75f)
            verticalLineToRelative(3.75f)
            horizontalLineToRelative(-3.75f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            reflectiveCurveTo(18.836f, 24f, 19.25f, 24f)
