...
public val FluentIcons.Light.ArrowHookUpRight32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Light.ArrowHookUpRight32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(22.776f, 24f, 22.5f, 24f)
            horizontalLineTo(13f)
