...
public val FluentIcons.Color.PersonFeedback24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.PersonFeedback24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(4.85406f, 15.9305f),
                end = Offset(7.40985f, 22.9276f)
            )
        ) {
            moveTo(8f, 22f)
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(8.00086f, 14.1667f),
                end = Offset(11.6078f, 25.7215f)
            )
        ) {
            moveTo(8f, 22f)
            curveToRelative(-2.06f, 0f, -3.64f, -0.56f, -4.7f, -1.67f)
