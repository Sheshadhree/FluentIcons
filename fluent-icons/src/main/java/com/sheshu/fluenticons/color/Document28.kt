...
public val FluentIcons.Color.Document28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.Document28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(19.5f, 2f),
                end = Offset(19.5f, 11f)
            )
        ) {
            moveTo(15f, 9.5f)
            verticalLineTo(2f)
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(19.485f, 5.75f),
                end = Offset(17.235f, 9.5f)
            )
        ) {
            moveTo(15f, 9.5f)
            verticalLineTo(2f)
