...
public val FluentIcons.Color.ChatMore20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.ChatMore20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(7.52483f, 8.07023f),
                end = Offset(7.97406f, 12.4141f)
            )
        ) {
            moveTo(10.5f, 11f)
