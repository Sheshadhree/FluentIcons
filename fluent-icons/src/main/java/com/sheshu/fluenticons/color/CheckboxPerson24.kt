...
public val FluentIcons.Color.CheckboxPerson24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.CheckboxPerson24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(18.5f, 17.4048f),
                end = Offset(20.9744f, 25.7267f)
            )
        ) {
            moveTo(23f, 19.875f)
            curveTo(23f, 21.431f, 21.714f, 23f, 18.5f, 23f)
