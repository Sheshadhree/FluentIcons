...
public val FluentIcons.Color.CheckmarkCircle24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.CheckmarkCircle24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(9.1875f, 9.41304f),
                end = Offset(10.681f, 16.7129f)
            )
        ) {
            moveTo(15.22f, 8.97f)
