...
public val FluentIcons.Color.TextBulletListSquareSparkle24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.TextBulletListSquareSparkle24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(
            fill = Brush.radialGradient(
                ...
                center = Offset(20.4375f, 10.875f),
                radius = 4.09821f
            )
        ) {
            moveTo(6.25f, 3f)
        ...
        path(
            fill = Brush.radialGradient(
                ...
                center = Offset(16.5402f, 4.44643f),
                radius = 5.66518f
            )
        ) {
            moveTo(6.25f, 3f)
        ...
        path(
            fill = Brush.radialGradient(
                ...
                center = Offset(20.317f, 11.2768f),
                radius = 2.72936f
            )
        ) {
            moveTo(6.25f, 3f)
