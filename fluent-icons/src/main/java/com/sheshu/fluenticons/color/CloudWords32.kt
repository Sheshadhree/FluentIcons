...
public val FluentIcons.Color.CloudWords32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.CloudWords32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(32.6667f, 25.3333f),
                end = Offset(23.4111f, 0.662066f)
            ),
            fillAlpha = 0.95f
        ) {
            moveTo(13f, 12f)
