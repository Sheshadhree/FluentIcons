...
public val FluentIcons.Color.CheckmarkCircle32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.CheckmarkCircle32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(12.0313f, 11.9691f),
                end = Offset(14.1624f, 22.6599f)
            )
        ) {
