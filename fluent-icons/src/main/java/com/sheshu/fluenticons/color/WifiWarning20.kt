...
public val FluentIcons.Color.WifiWarning20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.WifiWarning20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(11.4063f, 8.59375f),
                end = Offset(17.3125f, 19.8438f)
            )
        ) {
            moveTo(13.603f, 10.554f)
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(13.164f, 11.9946f),
                end = Offset(16.3711f, 17.6966f)
            )
        ) {
            moveTo(14.999f, 12.495f)
