...
public val FluentIcons.Color.BookOpenLightbulb32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.BookOpenLightbulb32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(
            ...
            moveTo(27.75f, 4f)
            curveTo(28.993f, 4f, 30f, 5.007f, 30f, 6.25f)
            verticalLineTo(24f)
            ...
            lineTo(15f, 16f)
            lineToRelative(1f, -10.166f)
            curveTo(16.87f, 4.718f, 18.226f, 4f, 19.75f, 4f)
            horizontalLineToRelative(8f)
            close()
        }
        path(
        ...
        path(
            fill = Brush.radialGradient(
                colorStops = arrayOf(
                    0.251056f to Color(0xFF2063C3),
                    0.714294f to Color(0x008AD6FF)
                ),
                center = Offset(26.5882f, 26f),
                radius = 18.1787f
            )
        ) {
            moveTo(28f, 5f)
            ...
            verticalLineTo(5f)
            close()
            moveToRelative(-0.179f, 24.393f)
            curveTo(27.634f, 30.327f, 26.814f, 31f, 25.861f, 31f)
            horizontalLineTo(25.14f)
            curveToRelative(-0.954f, 0f, -1.774f, -0.673f, -1.961f, -1.607f)
            lineTo(23f, 28.5f)
            lineToRelative(2.5f, -1f)
            lineToRelative(2.5f, 1f)
            lineToRelative(-0.179f, 0.893f)
            close()
        }
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(25.4996f, 27.5f),
                end = Offset(25.5f, 31f)
            )
        ) {
            moveTo(27.821f, 29.393f)
            curveTo(27.634f, 30.327f, 26.814f, 31f, 25.861f, 31f)
            horizontalLineTo(25.14f)
            curveToRelative(-0.954f, 0f, -1.774f, -0.673f, -1.961f, -1.607f)
            lineTo(23f, 28.5f)
            ...
            curveToRelative(0f, 1.941f, -1.007f, 3.645f, -2.525f, 4.624f)
            lineTo(28.3f, 27f)
            lineToRelative(-2.8f, 0.5f)
            lineToRelative(-2.8f, -0.5f)
            lineToRelative(-0.176f, -0.876f)
            curveTo(21.006f, 25.145f, 20f, 23.441f, 20f, 21.5f)
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(25.06f, 27.5958f),
                end = Offset(26.6435f, 29.9613f)
            )
        ) {
            moveTo(28.003f, 28.5f)
            horizontalLineToRelative(-5f)
