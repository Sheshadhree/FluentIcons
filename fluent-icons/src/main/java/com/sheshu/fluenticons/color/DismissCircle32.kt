...
public val FluentIcons.Color.DismissCircle32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.DismissCircle32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(10.6967f, 16.5303f),
                end = Offset(16.9451f, 23.0277f)
            )
        ) {
