...
public val FluentIcons.Color.DocumentText32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.DocumentText32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(22f, 29f),
                end = Offset(11.1052f, 10.3542f)
            ),
            fillAlpha = 0.9f
        ) {
            moveTo(11f, 23f)
