...
public val FluentIcons.Color.SearchSparkle16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Color.SearchSparkle16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(
            ...
            reflectiveCurveTo(11f, 4.015f, 11f, 6.5f)
            close()
        }
        path(
            fill = Brush.linearGradient(
                ...
                start = Offset(1.68421f, 12.6316f),
                end = Offset(12.6316f, 3.73684f)
            )
        ) {
        ...
        path(
            fill = Brush.radialGradient(
                ...
                center = Offset(2.375f, -12.8125f),
                radius = 28.6137f
            )
        ) {
            moveTo(15.783f, 8.213f)
