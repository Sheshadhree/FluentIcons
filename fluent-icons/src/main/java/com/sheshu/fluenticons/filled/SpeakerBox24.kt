...
public val FluentIcons.Filled.SpeakerBox24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.SpeakerBox24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(13.933f, 11f, 12f, 11f)
            reflectiveCurveToRelative(-3.5f, 1.567f, -3.5f, 3.5f)
            close()
            moveTo(12f, 9f)
