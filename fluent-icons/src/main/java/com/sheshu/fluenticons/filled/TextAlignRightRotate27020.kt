...
public val FluentIcons.Filled.TextAlignRightRotate27020: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextAlignRightRotate27020",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(3.5f, 2.336f, 3.836f, 2f, 4.25f, 2f)
            reflectiveCurveTo(5f, 2.336f, 5f, 2.75f)
            verticalLineToRelative(10.5f)
            curveTo(5f, 13.664f, 4.664f, 14f, 4.25f, 14f)
            close()
