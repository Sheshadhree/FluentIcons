...
public val FluentIcons.Filled.ContactCard48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ContactCard48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-9.5f)
            curveToRelative(-0.69f, 0f, -1.25f, -0.56f, -1.25f, -1.25f)
            reflectiveCurveTo(25.56f, 26f, 26.25f, 26f)
            close()
        }
    }.build()
}
