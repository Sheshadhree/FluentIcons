...
public val FluentIcons.Filled.CalendarLtr32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.CalendarLtr32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.672f, 18f, 9f, 17.328f, 9f, 16.5f)
            ...
            reflectiveCurveToRelative(1.5f, 0.672f, 1.5f, 1.5f)
            reflectiveCurveTo(16.828f, 23f, 16f, 23f)
            close()
