...
public val FluentIcons.Filled.PhoneLaptop20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PhoneLaptop20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(8.328f, 7f, 9f, 7.672f, 9f, 8.5f)
            ...
            curveToRelative(0.276f, 0f, 0.5f, -0.224f, 0.5f, -0.5f)
            reflectiveCurveTo(6.276f, 15f, 6f, 15f)
            horizontalLineTo(5f)
            close()
        }
    }.build()
