...
public val FluentIcons.Filled.MailInboxAll20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.MailInboxAll20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-7f)
            curveTo(6.224f, 8f, 6f, 7.776f, 6f, 7.5f)
            close()
            moveTo(3f, 6f)
