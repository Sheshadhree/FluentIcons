...
public val FluentIcons.Filled.Clipboard3Day20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Clipboard3Day20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-6f)
            curveTo(9.5f, 7.224f, 9.724f, 7f, 10f, 7f)
