...
public val FluentIcons.Filled.ListBarTreeOffset20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ListBarTreeOffset20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-1f)
            curveTo(7f, 13.672f, 7.672f, 13f, 8.5f, 13f)
            close()
        }
    }.build()
}
