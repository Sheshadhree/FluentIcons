...
public val FluentIcons.Filled.ShoppingBagAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ShoppingBagAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(12.53f, 2.289f, 13.232f, 2f, 14f, 2f)
            ...
            curveToRelative(-0.465f, 0f, -0.88f, 0.212f, -1.156f, 0.544f)
            curveTo(12.945f, 4.344f, 13f, 4.666f, 13f, 5f)
            verticalLineToRelative(7.81f)
            curveToRelative(-1.233f, 1.182f, -2f, 2.847f, -2f, 4.69f)
            curveToRelative(0f, 1.747f, 0.689f, 3.332f, 1.81f, 4.5f)
            horizontalLineTo(8f)
            ...
            reflectiveCurveTo(17f, 14.222f, 17f, 14.5f)
            verticalLineTo(17f)
