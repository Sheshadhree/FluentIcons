...
public val FluentIcons.Filled.TagPercent24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TagPercent24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 1.27f, 0.364f, 2.455f, 0.994f, 3.456f)
