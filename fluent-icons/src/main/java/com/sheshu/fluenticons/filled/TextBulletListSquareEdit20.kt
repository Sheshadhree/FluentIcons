...
public val FluentIcons.Filled.TextBulletListSquareEdit20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextBulletListSquareEdit20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.69f, 0.031f, -1.371f, 0.31f, -1.898f, 0.838f)
            lineTo(11.942f, 13f)
