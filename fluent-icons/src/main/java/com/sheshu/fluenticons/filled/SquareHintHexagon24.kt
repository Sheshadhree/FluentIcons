...
public val FluentIcons.Filled.SquareHintHexagon24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.SquareHintHexagon24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(4.932f, -6.25f)
            curveTo(8.95f, 7.286f, 9.445f, 7f, 9.982f, 7f)
            horizontalLineToRelative(4.039f)
            curveToRelative(0.536f, 0f, 1.031f, 0.286f, 1.299f, 0.75f)
            lineToRelative(2.02f, 3.5f)
            curveToRelative(0.268f, 0.465f, 0.268f, 1.036f, 0f, 1.5f)
            lineToRelative(-2.02f, 3.5f)
            curveToRelative(-0.268f, 0.465f, -0.763f, 0.75f, -1.3f, 0.75f)
            horizontalLineTo(9.982f)
            curveToRelative(-0.536f, 0f, -1.031f, -0.285f, -1.3f, -0.75f)
            lineToRelative(-2.02f, -3.5f)
            curveToRelative(-0.267f, -0.464f, -0.267f, -1.035f, 0f, -1.5f)
            lineToRelative(2.02f, -3.5f)
            close()
        }
    }.build()
