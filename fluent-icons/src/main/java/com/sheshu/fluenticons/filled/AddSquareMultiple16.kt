...
public val FluentIcons.Filled.AddSquareMultiple16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.AddSquareMultiple16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(6.5f, 4.224f, 6.5f, 4.5f)
            verticalLineToRelative(2f)
            close()
