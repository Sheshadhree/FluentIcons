...
public val FluentIcons.Filled.MailUnread32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.MailUnread32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 2.73f, 1.99f, 4.996f, 4.599f, 5.427f)
            lineTo(16f, 16.864f)
