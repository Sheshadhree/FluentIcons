...
public val FluentIcons.Filled.StarDismiss24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.StarDismiss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(19.743f, 11.302f, 18.656f, 11f, 17.5f, 11f)
            curveToRelative(-3.59f, 0f, -6.5f, 2.91f, -6.5f, 6.5f)
            curveToRelative(0f, 0.61f, 0.084f, 1.202f, 0.241f, 1.762f)
            ...
            curveTo(1.608f, 10.17f, 2.05f, 8.809f, 3.157f, 8.648f)
            lineTo(8.43f, 7.881f)
            lineToRelative(2.358f, -4.778f)
            close()
            moveTo(23f, 17.5f)
