...
public val FluentIcons.Filled.TextDensity24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextDensity24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(17f)
            close()
            moveToRelative(9.75f, 1f)
            horizontalLineTo(14.5f)
            verticalLineToRelative(-4.5f)
            horizontalLineToRelative(5.25f)
            curveToRelative(1.243f, 0f, 2.25f, 1.007f, 2.25f, 2.25f)
            reflectiveCurveTo(20.993f, 18f, 19.75f, 18f)
            close()
