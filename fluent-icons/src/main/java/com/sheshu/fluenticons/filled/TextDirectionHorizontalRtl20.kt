...
public val FluentIcons.Filled.TextDirectionHorizontalRtl20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextDirectionHorizontalRtl20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-3f, -7.5f)
            curveTo(14.082f, 3.186f, 13.806f, 3f, 13.5f, 3f)
            close()
