...
public val FluentIcons.Filled.CloudLink24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.CloudLink24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(2.233f, 0.206f, 3.993f, 2.044f, 4.077f, 4.31f)
            curveToRelative(-0.87f, -1.114f, -2.225f, -1.83f, -3.747f, -1.83f)
            horizontalLineToRelative(-3.5f)
            curveToRelative(-2.623f, 0f, -4.75f, 2.127f, -4.75f, 4.75f)
            curveToRelative(0f, 0.618f, 0.118f, 1.208f, 0.333f, 1.75f)
            ...
            curveTo(20.427f, 19.89f, 22f, 18.255f, 22f, 16.25f)
            close()
            moveToRelative(-6.5f, -3f)
            curveToRelative(0f, -0.414f, -0.336f, -0.75f, -0.75f, -0.75f)
            lineToRelative(-0.2f, 0.005f)
            curveTo(12.573f, 12.61f, 11f, 14.245f, 11f, 16.25f)
            curveToRelative(0f, 2.071f, 1.679f, 3.75f, 3.75f, 3.75f)
            lineToRelative(0.102f, -0.007f)
            curveToRelative(0.366f, -0.05f, 0.648f, -0.363f, 0.648f, -0.743f)
            curveToRelative(0f, -0.414f, -0.336f, -0.75f, -0.75f, -0.75f)
            ...
            horizontalLineToRelative(3.5f)
            lineToRelative(0.102f, -0.007f)
            curveTo(18.718f, 16.943f, 19f, 16.63f, 19f, 16.25f)
            close()
        }
    }.build()
}
