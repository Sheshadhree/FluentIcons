...
public val FluentIcons.Filled.ListBarTree16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ListBarTree16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(3f)
            horizontalLineTo(5.25f)
            curveTo(4.56f, 14f, 4f, 13.44f, 4f, 12.75f)
            verticalLineToRelative(-0.5f)
            curveTo(4f, 11.56f, 4.56f, 11f, 5.25f, 11f)
            close()
        }
    }.build()
}
