...
public val FluentIcons.Filled.PersonWarning16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PersonWarning16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(3.58f, 13.684f, 2f, 11.818f, 2f, 10f)
            verticalLineTo(9.5f)
