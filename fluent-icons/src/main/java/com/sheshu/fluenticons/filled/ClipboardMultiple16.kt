...
public val FluentIcons.Filled.ClipboardMultiple16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ClipboardMultiple16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineTo(6f)
            curveToRelative(-0.74f, 0f, -1.38f, -0.4f, -1.73f, -1f)
