...
public val FluentIcons.Filled.TableFreezeRowDismiss20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableFreezeRowDismiss20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(2.208f, -4f)
            curveTo(9.073f, 13.477f, 9f, 13.98f, 9f, 14.5f)
            curveToRelative(0f, 0.9f, 0.218f, 1.75f, 0.602f, 2.5f)
            horizontalLineTo(8f)
            verticalLineToRelative(-4f)
            horizontalLineToRelative(1.208f)
            close()
            moveToRelative(7.146f, -0.354f)
            ...
            curveTo(16.25f, 9.218f, 15.4f, 9f, 14.5f, 9f)
            curveToRelative(-0.52f, 0f, -1.023f, 0.073f, -1.5f, 0.208f)
            verticalLineTo(8f)
            ...
            close()
            moveTo(12f, 9.6f)
            curveToRelative(-1.03f, 0.527f, -1.871f, 1.37f, -2.398f, 2.4f)
            horizontalLineTo(8f)
            verticalLineTo(8f)
            horizontalLineToRelative(4f)
