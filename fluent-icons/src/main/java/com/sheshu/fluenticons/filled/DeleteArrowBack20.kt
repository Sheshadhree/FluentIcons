...
public val FluentIcons.Filled.DeleteArrowBack20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DeleteArrowBack20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(15.96f, 9.196f)
            curveTo(15.496f, 9.068f, 15.006f, 9f, 14.5f, 9f)
