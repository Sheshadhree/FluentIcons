...
public val FluentIcons.Filled.ImageAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ImageAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.276f, 0f, 0.5f, 0.224f, 0.5f, 0.5f)
            reflectiveCurveTo(9.772f, 7f, 9.496f, 7f)
            horizontalLineTo(7f)
            close()
            ...
            curveToRelative(-0.833f, -0.702f, -2.054f, -0.704f, -2.889f, -0.006f)
            lineToRelative(-0.135f, 0.123f)
            ...
            close()
            moveToRelative(8.75f, -2.25f)
            curveToRelative(1.105f, 0f, 2f, -0.895f, 2f, -2f)
            reflectiveCurveToRelative(-0.895f, -2f, -2f, -2f)
            reflectiveCurveToRelative(-2f, 0.895f, -2f, 2f)
            reflectiveCurveToRelative(0.895f, 2f, 2f, 2f)
            close()
            moveToRelative(-3.692f, 2.897f)
