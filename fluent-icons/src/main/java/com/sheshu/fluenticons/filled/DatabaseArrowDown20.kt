...
public val FluentIcons.Filled.DatabaseArrowDown20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DatabaseArrowDown20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 1.328f, 0.47f, 2.547f, 1.255f, 3.497f)
            lineTo(10f, 18f)
            curveToRelative(-3.314f, 0f, -6f, -1.343f, -6f, -3f)
