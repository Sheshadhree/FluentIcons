...
public val FluentIcons.Filled.PanelLeftTextAdd20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PanelLeftTextAdd20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.823f, 9.95f, 7f, 9.745f, 7f, 9.5f)
            curveTo(7f, 9.224f, 6.776f, 9f, 6.5f, 9f)
            horizontalLineToRelative(-2f)
            lineTo(4.41f, 9.008f)
            curveTo(4.177f, 9.05f, 4f, 9.255f, 4f, 9.5f)
            ...
            horizontalLineToRelative(-2f)
            lineToRelative(-0.09f, 0.008f)
            curveTo(4.177f, 12.05f, 4f, 12.255f, 4f, 12.5f)
            curveTo(4f, 12.776f, 4.224f, 13f, 4.5f, 13f)
            horizontalLineToRelative(2f)
            lineToRelative(0.09f, -0.008f)
            curveTo(6.823f, 12.95f, 7f, 12.745f, 7f, 12.5f)
            close()
