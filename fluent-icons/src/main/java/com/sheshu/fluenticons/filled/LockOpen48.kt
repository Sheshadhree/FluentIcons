...
public val FluentIcons.Filled.LockOpen48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.LockOpen48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(43f, 6.962f, 43f, 10f)
            verticalLineToRelative(1f)
            curveToRelative(0f, 0.69f, 0.56f, 1.25f, 1.25f, 1.25f)
            reflectiveCurveTo(45.5f, 11.69f, 45.5f, 11f)
            verticalLineToRelative(-1f)
