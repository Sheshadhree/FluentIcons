...
public val FluentIcons.Filled.TableFreezeRowDismiss24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableFreezeRowDismiss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(3.176f, -5f)
            curveTo(11.062f, 16.482f, 11f, 16.984f, 11f, 17.5f)
            curveToRelative(0f, 1.29f, 0.377f, 2.49f, 1.024f, 3.5f)
            horizontalLineTo(9.5f)
            verticalLineToRelative(-5f)
            horizontalLineToRelative(1.676f)
            close()
            moveToRelative(8.678f, -0.854f)
            ...
            curveTo(19.99f, 11.377f, 18.79f, 11f, 17.5f, 11f)
            curveToRelative(-0.516f, 0f, -1.018f, 0.062f, -1.5f, 0.176f)
            verticalLineTo(9.5f)
            ...
            close()
            moveToRelative(-3.25f, 8.733f)
            curveToRelative(-1.182f, 0.617f, -2.15f, 1.585f, -2.767f, 2.767f)
            horizontalLineTo(9.5f)
            verticalLineToRelative(-5f)
            horizontalLineToRelative(5f)
