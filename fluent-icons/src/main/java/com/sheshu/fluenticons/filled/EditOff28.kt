...
public val FluentIcons.Filled.EditOff28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.EditOff28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(6.187f, -6.186f)
            close()
            moveToRelative(-3.44f, -7.682f)
            lineToRelative(5.562f, 5.56f)
            lineToRelative(3.877f, -3.877f)
            lineToRelative(-5.56f, -5.56f)
            lineToRelative(-3.878f, 3.877f)
            close()
            moveToRelative(6.48f, -6.478f)
