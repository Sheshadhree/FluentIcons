...
public val FluentIcons.Filled.PanelLeftTextAdd48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PanelLeftTextAdd48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.411f, -0.79f, -0.744f, -1.626f, -0.987f, -2.5f)
