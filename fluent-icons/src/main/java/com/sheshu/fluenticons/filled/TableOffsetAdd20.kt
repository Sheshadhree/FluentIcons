...
public val FluentIcons.Filled.TableOffsetAdd20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableOffsetAdd20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-2.137f, 0f, -3.99f, 1.22f, -4.9f, 3f)
            horizontalLineTo(8f)
            verticalLineTo(8f)
            close()
