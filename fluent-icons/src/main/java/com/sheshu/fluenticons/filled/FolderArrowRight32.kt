...
public val FluentIcons.Filled.FolderArrowRight32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.FolderArrowRight32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(15.558f, 26.57f, 15f, 24.85f, 15f, 23f)
