...
public val FluentIcons.Filled.Print48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Print48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(14.455f, 41f, 13f, 39.545f, 13f, 37.75f)
            verticalLineTo(36f)
            horizontalLineTo(9.25f)
            curveTo(7.455f, 36f, 6f, 34.545f, 6f, 32.75f)
            verticalLineToRelative(-13.5f)
            curveTo(6f, 16.35f, 8.35f, 14f, 11.25f, 14f)
