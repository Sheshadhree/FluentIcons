...
public val FluentIcons.Filled.TextColumnTwo20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextColumnTwo20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(17f, 5.75f)
            curveTo(17f, 5.336f, 16.664f, 5f, 16.25f, 5f)
            ...
            horizontalLineToRelative(-4.5f)
            curveTo(11.336f, 11f, 11f, 11.336f, 11f, 11.75f)
            reflectiveCurveToRelative(0.336f, 0.75f, 0.75f, 0.75f)
            horizontalLineToRelative(4.5f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            close()
            moveToRelative(-8f, 0f)
            curveTo(9f, 11.336f, 8.664f, 11f, 8.25f, 11f)
            horizontalLineToRelative(-4.5f)
            ...
            close()
            moveToRelative(-8f, 0f)
            curveTo(9f, 14.336f, 8.664f, 14f, 8.25f, 14f)
            horizontalLineToRelative(-4.5f)
            curveTo(3.336f, 14f, 3f, 14.336f, 3f, 14.75f)
            reflectiveCurveToRelative(0.336f, 0.75f, 0.75f, 0.75f)
            horizontalLineToRelative(4.5f)
            curveTo(8.664f, 15.5f, 9f, 15.164f, 9f, 14.75f)
            close()
        }
    }.build()
}
