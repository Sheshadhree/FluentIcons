...
public val FluentIcons.Filled.BranchRequestClosed20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.BranchRequestClosed20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(5.5f, 7.958f)
            curveTo(6.919f, 7.721f, 8f, 6.487f, 8f, 5f)
            curveToRelative(0f, -1.657f, -1.343f, -3f, -3f, -3f)
            reflectiveCurveTo(2f, 3.343f, 2f, 5f)
