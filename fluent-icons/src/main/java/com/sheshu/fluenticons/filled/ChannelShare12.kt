...
public val FluentIcons.Filled.ChannelShare12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ChannelShare12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.291f, 8.583f, 6.847f, 9f, 7.5f, 9f)
            curveTo(8.328f, 9f, 9f, 8.328f, 9f, 7.5f)
            reflectiveCurveTo(8.328f, 6f, 7.5f, 6f)
            curveTo(6.847f, 6f, 6.291f, 6.417f, 6.085f, 7f)
            horizontalLineTo(3f)
            ...
            curveTo(5.709f, 3.417f, 5.153f, 3f, 4.5f, 3f)
