...
public val FluentIcons.Filled.VideoPersonStar24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.VideoPersonStar24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.444f, -0.425f, -0.949f, -0.789f, -1.5f, -1.075f)
            ...
            curveToRelative(0f, 0.888f, 0.178f, 1.734f, 0.5f, 2.505f)
            horizontalLineTo(4.25f)
