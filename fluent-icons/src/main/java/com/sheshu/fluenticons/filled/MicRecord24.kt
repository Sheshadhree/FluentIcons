...
public val FluentIcons.Filled.MicRecord24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.MicRecord24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(0.175f, -1.504f)
            curveTo(11.658f, 13.957f, 13.1f, 12.29f, 15f, 11.498f)
            verticalLineTo(6f)
