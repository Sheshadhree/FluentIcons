...
public val FluentIcons.Filled.CloudSync24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.CloudSync24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(6.08f, 8.02f)
            curveTo(6.548f, 5.171f, 9.02f, 3f, 12f, 3f)
            reflectiveCurveToRelative(5.452f, 2.172f, 5.92f, 5.02f)
            curveTo(20.208f, 8.23f, 22f, 10.155f, 22f, 12.5f)
            curveToRelative(0f, 0.166f, -0.009f, 0.33f, -0.027f, 0.492f)
            curveTo(20.818f, 11.192f, 18.798f, 10f, 16.5f, 10f)
            ...
            horizontalLineToRelative(-1f)
            curveToRelative(0.456f, 0.608f, 1.183f, 1f, 2f, 1f)
            curveToRelative(0.74f, 0f, 1.405f, -0.321f, 1.863f, -0.834f)
            curveToRelative(0.185f, -0.205f, 0.5f, -0.223f, 0.707f, -0.039f)
            curveToRelative(0.205f, 0.185f, 0.223f, 0.5f, 0.039f, 0.707f)
            curveTo(18.469f, 19.549f, 17.537f, 20f, 16.5f, 20f)
            curveToRelative(-0.98f, 0f, -1.865f, -0.403f, -2.5f, -1.05f)
            verticalLineToRelative(0.55f)
            curveToRelative(0f, 0.276f, -0.224f, 0.5f, -0.5f, 0.5f)
            reflectiveCurveTo(13f, 19.776f, 13f, 19.5f)
            verticalLineToRelative(-2f)
            close()
        }
    }.build()
