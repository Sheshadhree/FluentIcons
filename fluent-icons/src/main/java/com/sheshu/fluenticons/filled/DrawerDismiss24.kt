...
public val FluentIcons.Filled.DrawerDismiss24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DrawerDismiss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-0.058f)
            curveToRelative(0f, -0.382f, 0.31f, -0.692f, 0.692f, -0.692f)
