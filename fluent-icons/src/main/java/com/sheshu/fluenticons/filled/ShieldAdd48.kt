...
public val FluentIcons.Filled.ShieldAdd48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ShieldAdd48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.484f, -0.464f, -1.247f, -0.464f, -1.73f, 0f)
            ...
            lineTo(7.22f, 10f)
            curveTo(6.542f, 10.017f, 6f, 10.571f, 6f, 11.25f)
            verticalLineToRelative(9.5f)
            curveToRelative(0f, 4.837f, 1.243f, 9.658f, 4.098f, 13.775f)
            curveToRelative(2.861f, 4.126f, 7.29f, 7.469f, 13.529f, 9.418f)
            curveToRelative(0.243f, 0.076f, 0.503f, 0.076f, 0.746f, 0f)
            curveToRelative(0.31f, -0.097f, 0.615f, -0.197f, 0.916f, -0.3f)
            curveTo(23.243f, 41.344f, 22f, 38.317f, 22f, 35f)
            curveToRelative(0f, -7.18f, 5.82f, -13f, 13f, -13f)
            curveToRelative(2.508f, 0f, 4.85f, 0.71f, 6.835f, 1.94f)
            curveTo(41.945f, 22.964f, 42f, 21.982f, 42f, 21f)
            verticalLineToRelative(-9.75f)
            curveToRelative(0f, -0.679f, -0.542f, -1.234f, -1.22f, -1.25f)
            curveToRelative(-0.035f, 0f, -0.068f, -0.002f, -0.102f, -0.003f)
