...
public val FluentIcons.Filled.TableCellCenterEdit20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableCellCenterEdit20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(15.103f, 9.84f)
            curveTo(15.63f, 9.315f, 16.31f, 9.036f, 17f, 9.004f)
            verticalLineTo(8f)
            horizontalLineToRelative(-4f)
            verticalLineToRelative(3.944f)
            lineToRelative(2.103f, -2.103f)
            close()
            moveToRelative(-4.83f, 4.83f)
