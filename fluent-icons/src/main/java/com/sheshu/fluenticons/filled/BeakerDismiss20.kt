...
public val FluentIcons.Filled.BeakerDismiss20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.BeakerDismiss20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 0.172f, 0.013f, 0.343f, 0.038f, 0.511f)
            curveTo(11.54f, 9.607f, 10.295f, 10.64f, 9.6f, 12f)
            ...
            curveTo(9.216f, 16.252f, 9f, 15.4f, 9f, 14.5f)
            close()
