...
public val FluentIcons.Filled.GiftCardAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.GiftCardAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.255f, -3.356f, 3.06f, -6f, 6.481f, -6f)
            ...
            reflectiveCurveToRelative(0.448f, -1f, 1f, -1f)
            curveToRelative(0.55f, 0f, 0.996f, 0.444f, 1f, 0.992f)
            verticalLineTo(8f)
            close()
            moveToRelative(15f, 9.5f)
