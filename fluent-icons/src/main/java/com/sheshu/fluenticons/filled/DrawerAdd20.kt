...
public val FluentIcons.Filled.DrawerAdd20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DrawerAdd20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(15.776f, 5f, 15.5f, 5f)
            ...
            curveTo(8.306f, 7.349f, 8.437f, 7.683f, 8.6f, 8f)
            horizontalLineTo(4f)
