...
public val FluentIcons.Filled.Apps28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Apps28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(13.5f, 10.694f)
            lineToRelative(3.806f, 3.806f)
