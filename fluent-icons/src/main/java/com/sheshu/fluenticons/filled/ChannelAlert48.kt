...
public val FluentIcons.Filled.ChannelAlert48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ChannelAlert48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(12.25f, 6f)
            curveToRelative(-2.924f, 0f, -5.379f, 2.008f, -6.061f, 4.72f)
            curveToRelative(0.41f, -0.143f, 0.852f, -0.22f, 1.311f, -0.22f)
            ...
            curveToRelative(0f, -2.368f, 0.633f, -4.588f, 1.74f, -6.5f)
            horizontalLineToRelative(-6.49f)
            curveToRelative(-0.69f, 0f, -1.25f, -0.56f, -1.25f, -1.25f)
            reflectiveCurveTo(16.56f, 26f, 17.25f, 26f)
            horizontalLineToRelative(8.37f)
            curveToRelative(2.365f, -2.465f, 5.693f, -4f, 9.38f, -4f)
            ...
            curveTo(29.165f, 38.91f, 29.327f, 39f, 29.5f, 39f)
            horizontalLineToRelative(11f)
            curveToRelative(0.173f, 0f, 0.334f, -0.09f, 0.425f, -0.237f)
            curveToRelative(0.091f, -0.148f, 0.1f, -0.332f, 0.022f, -0.487f)
            lineTo(40f, 36.382f)
            verticalLineTo(33f)
