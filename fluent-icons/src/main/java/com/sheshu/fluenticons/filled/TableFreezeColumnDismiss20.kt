...
public val FluentIcons.Filled.TableFreezeColumnDismiss20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableFreezeColumnDismiss20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(12f, 9.601f)
            curveTo(10.97f, 10.127f, 10.129f, 10.97f, 9.602f, 12f)
            horizontalLineTo(8f)
            verticalLineTo(8f)
            ...
            curveTo(16.25f, 9.217f, 15.4f, 9f, 14.5f, 9f)
