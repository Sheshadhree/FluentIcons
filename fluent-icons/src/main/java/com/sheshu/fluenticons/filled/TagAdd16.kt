...
public val FluentIcons.Filled.TagAdd16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TagAdd16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(1.587f, 6.314f)
            curveToRelative(-0.783f, 0.78f, -0.783f, 2.043f, 0f, 2.822f)
            lineToRelative(3.296f, 3.28f)
            curveToRelative(0.19f, 0.188f, 0.408f, 0.331f, 0.64f, 0.428f)
            curveTo(5.188f, 12.134f, 5f, 11.34f, 5f, 10.5f)
            curveTo(5f, 7.462f, 7.462f, 5f, 10.5f, 5f)
            curveToRelative(0.893f, 0f, 1.736f, 0.213f, 2.481f, 0.59f)
            lineTo(13f, 3.01f)
            curveToRelative(0.008f, -1.111f, -0.897f, -2.015f, -2.013f, -2.01f)
            lineToRelative(-3.25f, 0.014f)
            curveTo(7.206f, 1.016f, 6.7f, 1.226f, 6.326f, 1.598f)
