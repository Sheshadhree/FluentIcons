...
public val FluentIcons.Filled.ContentView28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ContentView28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(7.724f, 8.5f, 7.5f, 8.724f, 7.5f, 9f)
            verticalLineToRelative(2f)
            ...
            reflectiveCurveTo(6.336f, 15f, 6.75f, 15f)
            close()
            moveTo(6f, 19.5f)
            ...
            reflectiveCurveToRelative(-0.336f, 0.75f, -0.75f, 0.75f)
            horizontalLineToRelative(-5.5f)
            curveTo(6.336f, 20.25f, 6f, 19.914f, 6f, 19.5f)
            close()
