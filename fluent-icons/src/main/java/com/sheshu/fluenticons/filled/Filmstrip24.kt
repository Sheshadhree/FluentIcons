...
public val FluentIcons.Filled.Filmstrip24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Filmstrip24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(20f, 16.664f, 20f, 16.25f)
            verticalLineToRelative(-0.5f)
            curveToRelative(0f, -0.414f, -0.336f, -0.75f, -0.75f, -0.75f)
            close()
            ...
            verticalLineToRelative(0.5f)
            curveToRelative(0f, 0.414f, 0.336f, 0.75f, 0.75f, 0.75f)
            reflectiveCurveTo(20f, 12.664f, 20f, 12.25f)
            verticalLineToRelative(-0.5f)
            curveToRelative(0f, -0.414f, -0.336f, -0.75f, -0.75f, -0.75f)
            ...
            reflectiveCurveTo(5.5f, 8.664f, 5.5f, 8.25f)
            verticalLineToRelative(-0.5f)
            ...
            reflectiveCurveTo(4f, 15.336f, 4f, 15.75f)
            close()
            moveTo(4.75f, 11f)
