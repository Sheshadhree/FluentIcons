...
public val FluentIcons.Filled.DecimalArrowRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DecimalArrowRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            moveTo(19f, 7f)
            verticalLineToRelative(4f)
            curveToRelative(0f, 0.058f, -0.005f, 0.115f, -0.015f, 0.17f)
            curveToRelative(0.669f, 0.157f, 1.297f, 0.416f, 1.868f, 0.76f)
            ...
            curveToRelative(0.612f, -0.25f, 1.272f, -0.41f, 1.961f, -0.463f)
            verticalLineTo(7f)
            curveToRelative(0f, -0.552f, 0.448f, -1f, 1f, -1f)
            reflectiveCurveToRelative(1f, 0.448f, 1f, 1f)
            close()
