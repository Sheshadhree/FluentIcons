...
public val FluentIcons.Filled.WalkieTalkie24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.WalkieTalkie24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(14f)
            curveToRelative(0f, 0.188f, -0.071f, 0.37f, -0.199f, 0.509f)
            lineToRelative(-1.301f, 1.41f)
            ...
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(14.164f, 14f, 13.75f, 14f)
            horizontalLineToRelative(-3.5f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            close()
        }
