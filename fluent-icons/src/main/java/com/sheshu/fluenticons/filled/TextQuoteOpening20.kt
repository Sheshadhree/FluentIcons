...
public val FluentIcons.Filled.TextQuoteOpening20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextQuoteOpening20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.746f, 0.747f, -1.663f, 1.664f, -2.385f, 2.976f)
            curveTo(11.52f, 9.462f, 11f, 11.17f, 11f, 13.5f)
            close()
            moveToRelative(-5.826f, -2.12f)
            curveTo(5.558f, 11.14f, 6.013f, 11f, 6.5f, 11f)
            curveTo(7.88f, 11f, 9f, 12.12f, 9f, 13.5f)
            reflectiveCurveTo(7.88f, 16f, 6.5f, 16f)
            reflectiveCurveTo(4f, 14.88f, 4f, 13.5f)
            curveToRelative(0f, -2.33f, 0.52f, -4.038f, 1.25f, -5.366f)
            curveToRelative(0.721f, -1.312f, 1.638f, -2.23f, 2.385f, -2.976f)
