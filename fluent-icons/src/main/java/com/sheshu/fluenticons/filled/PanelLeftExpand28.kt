...
public val FluentIcons.Filled.PanelLeftExpand28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PanelLeftExpand28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(13.336f, 14.75f, 13f, 14.414f, 13f, 14f)
            reflectiveCurveToRelative(0.336f, -0.75f, 0.75f, -0.75f)
            horizontalLineToRelative(5.69f)
            lineToRelative(-1.72f, -1.72f)
            close()
            moveTo(22.25f, 4f)
            curveTo(24.322f, 4f, 26f, 5.679f, 26f, 7.75f)
