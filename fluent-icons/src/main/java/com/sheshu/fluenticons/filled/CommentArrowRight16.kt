...
public val FluentIcons.Filled.CommentArrowRight16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.CommentArrowRight16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(8.147f, 5.146f)
            lineTo(8.144f, 5.149f)
            curveTo(8.097f, 5.196f, 8.062f, 5.25f, 8.038f, 5.309f)
            curveTo(8.014f, 5.367f, 8f, 5.43f, 8f, 5.497f)
