...
public val FluentIcons.Filled.InfoSparkle24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.InfoSparkle24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(21.46f, 14.05f)
            curveToRelative(0.125f, 0f, 0.238f, -0.015f, 0.341f, -0.042f)
            curveToRelative(-0.929f, 4.562f, -4.963f, 7.994f, -9.8f, 7.994f)
            curveTo(6.479f, 22.002f, 2f, 17.524f, 2f, 12.001f)
            curveTo(2f, 6.477f, 6.478f, 1.999f, 12.002f, 1.999f)
            curveToRelative(0.957f, 0f, 1.883f, 0.135f, 2.76f, 0.386f)
            curveToRelative(-0.117f, 0.072f, -0.242f, 0.13f, -0.372f, 0.174f)
