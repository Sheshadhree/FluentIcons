...
public val FluentIcons.Filled.WindowMultipleSwap20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.WindowMultipleSwap20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.384f, 0f, 0.768f, -0.146f, 1.06f, -0.44f)
            lineTo(9.122f, 17f)
