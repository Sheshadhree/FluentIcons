...
public val FluentIcons.Filled.EditProhibited48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.EditProhibited48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(2.478f, -2.477f)
            lineToRelative(-9.768f, -9.768f)
            close()
            moveTo(33f, 46f)
            curveToRelative(6.075f, 0f, 11f, -4.924f, 11f, -11f)
