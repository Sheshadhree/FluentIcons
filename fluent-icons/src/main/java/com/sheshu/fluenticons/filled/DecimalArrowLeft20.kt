...
public val FluentIcons.Filled.DecimalArrowLeft20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DecimalArrowLeft20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(13.477f, 9.072f, 13.98f, 9f, 14.5f, 9f)
            verticalLineTo(5.5f)
            curveToRelative(0f, -0.552f, 0.448f, -1f, 1f, -1f)
            reflectiveCurveToRelative(1f, 0.448f, 1f, 1f)
            verticalLineToRelative(3.875f)
            curveToRelative(0.51f, 0.2f, 0.983f, 0.472f, 1.406f, 0.806f)
