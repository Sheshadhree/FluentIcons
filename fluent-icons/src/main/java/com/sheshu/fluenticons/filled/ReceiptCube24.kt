...
public val FluentIcons.Filled.ReceiptCube24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ReceiptCube24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(11.88f, 20.628f, 12f, 20.2f, 12f, 19.753f)
            verticalLineTo(15.25f)
            curveToRelative(0f, -0.947f, -0.535f, -1.813f, -1.382f, -2.236f)
            lineTo(9.59f, 12.5f)
            horizontalLineToRelative(4.16f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(14.164f, 11f, 13.75f, 11f)
            horizontalLineToRelative(-5.5f)
            curveToRelative(-0.319f, 0f, -0.591f, 0.2f, -0.7f, 0.48f)
            lineToRelative(-0.432f, -0.216f)
