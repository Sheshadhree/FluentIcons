...
public val FluentIcons.Filled.ClipboardTaskAdd20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ClipboardTaskAdd20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(6.5f, 2f)
            curveTo(5.847f, 2f, 5.291f, 2.417f, 5.085f, 3f)
            ...
            curveTo(10.709f, 2.417f, 10.153f, 2f, 9.5f, 2f)
