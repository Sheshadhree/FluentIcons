...
public val FluentIcons.Filled.TextArrowDownRightColumn16: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextArrowDownRightColumn16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(1f, 2.776f, 1.224f, 3f, 1.5f, 3f)
            ...
            curveTo(9f, 14.216f, 9.784f, 15f, 10.75f, 15f)
            horizontalLineToRelative(1.5f)
