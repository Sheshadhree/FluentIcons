...
public val FluentIcons.Filled.ChannelAdd16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ChannelAdd16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(1.63f, 2.29f)
            curveTo(1.75f, 2.263f, 1.873f, 2.25f, 2f, 2.25f)
            curveToRelative(0.966f, 0f, 1.75f, 0.784f, 1.75f, 1.75f)
            reflectiveCurveTo(2.966f, 5.75f, 2f, 5.75f)
            curveToRelative(-0.174f, 0f, -0.342f, -0.025f, -0.5f, -0.072f)
            verticalLineTo(8f)
            curveToRelative(0f, 1.105f, 0.895f, 2f, 2f, 2f)
            horizontalLineToRelative(1.522f)
            curveTo(5.275f, 7.197f, 7.631f, 5f, 10.5f, 5f)
            verticalLineTo(3f)
            curveToRelative(0f, -1.105f, -0.895f, -2f, -2f, -2f)
            horizontalLineToRelative(-5f)
            curveTo(2.646f, 1f, 1.917f, 1.536f, 1.63f, 2.29f)
            close()
            moveTo(4f, 4.5f)
            ...
            reflectiveCurveTo(6.276f, 7f, 6f, 7f)
            horizontalLineTo(4.5f)
            close()
            moveTo(2.75f, 4f)
            curveToRelative(0f, 0.414f, -0.336f, 0.75f, -0.75f, 0.75f)
            reflectiveCurveTo(1.25f, 4.414f, 1.25f, 4f)
            reflectiveCurveTo(1.586f, 3.25f, 2f, 3.25f)
            reflectiveCurveTo(2.75f, 3.586f, 2.75f, 4f)
            close()
            moveTo(15f, 10.5f)
