...
public val FluentIcons.Filled.LinkDismiss24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.LinkDismiss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, -2.689f, 2.122f, -4.882f, 4.783f, -4.995f)
            lineTo(7f, 5f)
            horizontalLineToRelative(2f)
            close()
            moveToRelative(8f, 0f)
            curveToRelative(2.761f, 0f, 5f, 2.239f, 5f, 5f)
            curveToRelative(0f, 0.838f, -0.206f, 1.628f, -0.57f, 2.322f)
            curveToRelative(-0.53f, -0.402f, -1.122f, -0.725f, -1.76f, -0.951f)
            curveTo(19.88f, 10.96f, 20f, 10.494f, 20f, 10f)
            curveToRelative(0f, -1.598f, -1.249f, -2.904f, -2.824f, -2.995f)
            lineTo(17f, 7f)
            horizontalLineToRelative(-2f)
            curveToRelative(-0.552f, 0f, -1f, -0.448f, -1f, -1f)
