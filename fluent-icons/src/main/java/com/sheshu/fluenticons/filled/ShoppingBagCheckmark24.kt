...
public val FluentIcons.Filled.ShoppingBagCheckmark24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ShoppingBagCheckmark24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, -1.843f, 0.767f, -3.508f, 2f, -4.69f)
            verticalLineTo(5f)
            ...
            verticalLineToRelative(4.732f)
            curveToRelative(0.898f, -0.468f, 1.918f, -0.732f, 3f, -0.732f)
