...
public val FluentIcons.Filled.TableCellCenterEdit28: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableCellCenterEdit28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.713f, -0.713f, 1.674f, -1.03f, 2.606f, -0.95f)
            close()
            moveToRelative(0f, -6.262f)
            verticalLineTo(9.5f)
            horizontalLineToRelative(-6.5f)
            verticalLineTo(3f)
