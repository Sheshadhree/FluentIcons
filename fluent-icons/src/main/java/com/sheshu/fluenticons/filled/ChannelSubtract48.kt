...
public val FluentIcons.Filled.ChannelSubtract48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ChannelSubtract48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(0.189f, -1.78f)
            curveTo(6.599f, 10.577f, 7.04f, 10.5f, 7.5f, 10.5f)
