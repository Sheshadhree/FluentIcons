...
public val FluentIcons.Filled.TextAlignCenter16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextAlignCenter16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-4.5f)
            curveTo(5.336f, 12.5f, 5f, 12.164f, 5f, 11.75f)
            close()
        }
    }.build()
}
