...
public val FluentIcons.Filled.TextListRomanNumeralLowercase24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextListRomanNumeralLowercase24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(5.664f, 16f, 5.25f, 16f)
            reflectiveCurveTo(4.5f, 16.336f, 4.5f, 16.75f)
            reflectiveCurveToRelative(0.336f, 0.75f, 0.75f, 0.75f)
            close()
            moveTo(6f, 9.75f)
            curveToRelative(0f, 0.414f, -0.336f, 0.75f, -0.75f, 0.75f)
            reflectiveCurveTo(4.5f, 10.164f, 4.5f, 9.75f)
            reflectiveCurveTo(4.836f, 9f, 5.25f, 9f)
            reflectiveCurveTo(6f, 9.336f, 6f, 9.75f)
            close()
        }
    }.build()
}
