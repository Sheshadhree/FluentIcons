...
public val FluentIcons.Filled.StarAdd28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.StarAdd28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(22.77f, 13.266f, 21.666f, 13f, 20.5f, 13f)
            ...
            reflectiveCurveTo(20f, 16.223f, 20f, 16.5f)
            verticalLineTo(20f)
