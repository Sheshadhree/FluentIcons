...
public val FluentIcons.Filled.ScreenshotRecord24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ScreenshotRecord24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(10.664f, 18f, 10.25f, 18f)
            horizontalLineTo(8f)
