...
public val FluentIcons.Filled.ShoppingBagPercent24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ShoppingBagPercent24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-1.082f, 0f, -2.102f, 0.265f, -3f, 0.732f)
            verticalLineTo(7f)
            horizontalLineToRelative(1f)
            verticalLineTo(5f)
            curveToRelative(0f, -0.828f, -0.672f, -1.5f, -1.5f, -1.5f)
            curveToRelative(-0.465f, 0f, -0.88f, 0.212f, -1.155f, 0.544f)
