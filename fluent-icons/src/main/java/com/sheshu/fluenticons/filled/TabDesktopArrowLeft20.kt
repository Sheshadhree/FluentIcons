...
public val FluentIcons.Filled.TabDesktopArrowLeft20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TabDesktopArrowLeft20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(4.102f)
            curveTo(3.747f, 9.217f, 4.598f, 9f, 5.5f, 9f)
