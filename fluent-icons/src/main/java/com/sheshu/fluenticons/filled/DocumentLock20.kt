...
public val FluentIcons.Filled.DocumentLock20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DocumentLock20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(4.954f, 9f, 4.441f, 9.146f, 4f, 9.401f)
            verticalLineTo(3.5f)
            ...
            reflectiveCurveTo(4.75f, 16.414f, 4.75f, 16f)
            reflectiveCurveToRelative(0.336f, -0.75f, 0.75f, -0.75f)
            close()
        }
    }.build()
