...
public val FluentIcons.Filled.FolderArrowLeft28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.FolderArrowLeft28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(13.558f, 22.747f, 13f, 21.188f, 13f, 19.5f)
            curveToRelative(0f, -4.142f, 3.358f, -7.5f, 7.5f, -7.5f)
            curveToRelative(2.173f, 0f, 4.13f, 0.924f, 5.5f, 2.402f)
            verticalLineTo(9.75f)
            curveTo(26f, 7.679f, 24.322f, 6f, 22.25f, 6f)
            ...
            curveTo(16.014f, 19.367f, 16f, 19.43f, 16f, 19.497f)
