...
public val FluentIcons.Filled.LockClosedRibbon24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.LockClosedRibbon24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.625f, -0.774f, -1f, -1.758f, -1f, -2.83f)
            curveToRelative(0f, -2.486f, 2.014f, -4.501f, 4.5f, -4.501f)
            ...
            reflectiveCurveTo(16f, 13.567f, 16f, 15.5f)
            curveToRelative(0f, 0.846f, 0.3f, 1.621f, 0.8f, 2.226f)
            curveToRelative(0.063f, 0.078f, 0.13f, 0.152f, 0.2f, 0.224f)
            ...
            curveToRelative(0f, 0.624f, -0.754f, 0.936f, -1.195f, 0.495f)
            lineTo(19.5f, 21.49f)
