...
public val FluentIcons.Filled.ArrowExportLtr20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ArrowExportLtr20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(2f, 15.914f, 2f, 15.5f)
            verticalLineToRelative(-11f)
            curveToRelative(0f, -0.414f, 0.336f, -0.75f, 0.75f, -0.75f)
            close()
            moveTo(5f, 10f)
            ...
            curveTo(18.477f, 9.784f, 18.5f, 9.89f, 18.5f, 10f)
