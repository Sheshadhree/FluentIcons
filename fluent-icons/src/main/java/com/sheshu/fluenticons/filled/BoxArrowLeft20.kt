...
public val FluentIcons.Filled.BoxArrowLeft20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.BoxArrowLeft20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.18f, 12.903f, 9f, 13.68f, 9f, 14.499f)
            curveToRelative(0f, 0.82f, 0.18f, 1.597f, 0.5f, 2.295f)
            ...
            lineToRelative(7.465f, -2.986f)
            curveTo(17.988f, 5.957f, 18f, 6.066f, 18f, 6.176f)
            close()
            moveToRelative(1f, 8.323f)
