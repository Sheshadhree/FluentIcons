...
public val FluentIcons.Filled.DocumentArrowLeft48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DocumentArrowLeft48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineTo(23.248f)
            curveTo(24.972f, 40.794f, 26f, 38.017f, 26f, 35f)
            curveToRelative(0f, -7.18f, -5.82f, -13f, -13f, -13f)
            curveToRelative(-1.772f, 0f, -3.46f, 0.355f, -5f, 0.996f)
            verticalLineTo(7f)
            curveToRelative(0f, -1.657f, 1.343f, -3f, 3f, -3f)
