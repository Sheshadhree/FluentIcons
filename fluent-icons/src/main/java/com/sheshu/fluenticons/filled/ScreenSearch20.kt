...
public val FluentIcons.Filled.ScreenSearch20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.ScreenSearch20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(8.843f, 13.853f, 9f, 13.195f, 9f, 12.5f)
            curveTo(9f, 10.015f, 6.985f, 8f, 4.5f, 8f)
            curveTo(3.575f, 8f, 2.715f, 8.28f, 2f, 8.758f)
