...
public val FluentIcons.Filled.DesktopArrowDown20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.DesktopArrowDown20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(6.757f)
            curveTo(9.472f, 2.95f, 9f, 4.17f, 9f, 5.5f)
