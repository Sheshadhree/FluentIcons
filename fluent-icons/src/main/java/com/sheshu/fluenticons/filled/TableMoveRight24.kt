...
public val FluentIcons.Filled.TableMoveRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableMoveRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.036f, 0.25f, -0.018f, 0.506f, 0.054f, 0.75f)
            horizontalLineTo(12.75f)
            curveTo(11.784f, 10.25f, 11f, 11.034f, 11f, 12f)
            reflectiveCurveToRelative(0.784f, 1.75f, 1.75f, 1.75f)
            horizontalLineToRelative(0.822f)
            curveToRelative(-0.072f, 0.244f, -0.09f, 0.5f, -0.054f, 0.75f)
