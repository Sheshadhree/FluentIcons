...
public val FluentIcons.Filled.TableAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TableAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-1.182f, 0.617f, -2.152f, 1.586f, -2.768f, 2.768f)
            horizontalLineTo(9.5f)
            verticalLineToRelative(-5f)
            horizontalLineToRelative(5f)
            close()
