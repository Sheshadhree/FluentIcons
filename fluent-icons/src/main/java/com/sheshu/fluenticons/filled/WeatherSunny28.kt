...
public val FluentIcons.Filled.WeatherSunny28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.WeatherSunny28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(4.25f, 14.75f)
            curveTo(4.664f, 14.75f, 5f, 14.414f, 5f, 14f)
            reflectiveCurveToRelative(-0.336f, -0.75f, -0.75f, -0.75f)
