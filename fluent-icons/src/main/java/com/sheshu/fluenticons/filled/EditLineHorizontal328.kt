...
public val FluentIcons.Filled.EditLineHorizontal328: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.EditLineHorizontal328",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(16.688f, 5.75f)
            lineToRelative(5.56f, 5.562f)
            close()
            moveTo(6.524f, 14.5f)
            ...
            close()
            moveTo(17.75f, 3f)
            curveToRelative(0.081f, 0f, 0.16f, 0.016f, 0.233f, 0.04f)
            lineTo(16.524f, 4.5f)
            horizontalLineTo(2.75f)
