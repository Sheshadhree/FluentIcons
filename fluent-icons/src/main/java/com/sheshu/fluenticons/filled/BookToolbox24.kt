...
public val FluentIcons.Filled.BookToolbox24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.BookToolbox24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(14.784f, 1.25f, 14f, 2.034f, 14f, 3f)
            ...
            reflectiveCurveTo(16f, 9.664f, 16f, 9.25f)
            verticalLineTo(8.5f)
            horizontalLineToRelative(3f)
            verticalLineToRelative(0.75f)
            ...
            horizontalLineToRelative(6.688f)
