...
public val FluentIcons.Filled.Alert24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Alert24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(2.958f, -17f)
            curveToRelative(4.142f, 0f, 7.5f, 3.359f, 7.5f, 7.5f)
