...
public val FluentIcons.Filled.PeopleSync24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.PeopleSync24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 0.656f, 0.097f, 1.29f, 0.278f, 1.887f)
            curveTo(10.458f, 19.76f, 9.39f, 20f, 8f, 20f)
            curveToRelative(-6f, 0f, -6f, -4.5f, -6f, -4.5f)
