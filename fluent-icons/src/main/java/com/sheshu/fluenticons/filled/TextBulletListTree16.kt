...
public val FluentIcons.Filled.TextBulletListTree16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.TextBulletListTree16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(4.75f, 3f)
            curveToRelative(0f, 0.69f, -0.56f, 1.25f, -1.25f, 1.25f)
            reflectiveCurveTo(4.5f, 12.94f, 4.5f, 12.25f)
            reflectiveCurveTo(5.06f, 11f, 5.75f, 11f)
            reflectiveCurveTo(7f, 11.56f, 7f, 12.25f)
            close()
            moveTo(5.75f, 3f)
            ...
            close()
            moveToRelative(4.25f, 3.5f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            reflectiveCurveTo(8.836f, 13f, 9.25f, 13f)
