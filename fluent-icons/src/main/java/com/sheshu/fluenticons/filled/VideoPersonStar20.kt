...
public val FluentIcons.Filled.VideoPersonStar20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.VideoPersonStar20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.216f, 12.75f, 9f, 13.6f, 9f, 14.5f)
            ...
            curveToRelative(0f, 0.337f, -0.067f, 0.659f, -0.188f, 0.952f)
            curveToRelative(-0.796f, 0.346f, -1.495f, 0.875f, -2.043f, 1.534f)
            curveTo(10.181f, 10.996f, 10.091f, 11f, 10f, 11f)
            curveToRelative(-1.38f, 0f, -2.5f, -1.12f, -2.5f, -2.5f)
            reflectiveCurveTo(8.62f, 6f, 10f, 6f)
