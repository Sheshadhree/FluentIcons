...
public val FluentIcons.Regular.ArrowHookDownRight24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ArrowHookDownRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(16.414f, 4f, 16f, 4f)
            ...
            curveTo(18.99f, 16.384f, 19f, 16.318f, 19f, 16.25f)
