...
public val FluentIcons.Regular.ShieldArrowRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ShieldArrowRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(11f)
            curveToRelative(0f, 0.338f, -0.014f, 0.67f, -0.04f, 0.996f)
            curveToRelative(-0.454f, -0.285f, -0.945f, -0.517f, -1.465f, -0.684f)
            curveTo(19.498f, 11.21f, 19.5f, 11.105f, 19.5f, 11f)
            ...
            verticalLineTo(11f)
            curveToRelative(0f, 4.149f, 2.332f, 7.221f, 7.125f, 9.285f)
            curveToRelative(0.263f, 0.554f, 0.603f, 1.065f, 1.005f, 1.52f)
            lineToRelative(-0.355f, 0.143f)
            curveToRelative(-0.177f, 0.07f, -0.373f, 0.07f, -0.55f, 0f)
            curveTo(5.958f, 19.676f, 3f, 16f, 3f, 11f)
            verticalLineTo(5.75f)
            close()
            moveToRelative(20f, 11.746f)
