...
public val FluentIcons.Regular.PersonAccount16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PersonAccount16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(7.415f, 8.158f, 6.871f, 8.509f, 6.502f, 9f)
            horizontalLineTo(3.5f)
            curveTo(3.224f, 9f, 3f, 9.224f, 3f, 9.5f)
            verticalLineTo(10f)
            curveToRelative(0f, 1.239f, 1.063f, 2.568f, 3f, 2.913f)
