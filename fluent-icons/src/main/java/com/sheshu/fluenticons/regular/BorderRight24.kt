...
public val FluentIcons.Regular.BorderRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.BorderRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(3f, 10.336f, 3f, 10.75f)
            ...
            horizontalLineToRelative(-0.5f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            reflectiveCurveTo(17.336f, 21f, 17.75f, 21f)
            horizontalLineToRelative(0.5f)
