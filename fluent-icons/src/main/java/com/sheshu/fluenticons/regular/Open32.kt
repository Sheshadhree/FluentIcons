...
public val FluentIcons.Regular.Open32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Open32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(5f, 25.433f, 6.567f, 27f, 8.5f, 27f)
            ...
            horizontalLineToRelative(-15f)
            curveTo(5.462f, 29f, 3f, 26.538f, 3f, 23.5f)
            verticalLineToRelative(-15f)
            curveTo(3f, 5.462f, 5.462f, 3f, 8.5f, 3f)
