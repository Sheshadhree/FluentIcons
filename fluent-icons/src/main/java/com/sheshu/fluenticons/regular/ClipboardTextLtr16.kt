...
public val FluentIcons.Regular.ClipboardTextLtr16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ClipboardTextLtr16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(7.776f, 9.5f, 7.5f, 9.5f)
            horizontalLineToRelative(-2f)
