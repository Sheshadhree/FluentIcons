...
public val FluentIcons.Regular.BookTheta20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.BookTheta20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.025f, 11.724f, 9.513f, 12f, 10f, 12f)
            reflectiveCurveToRelative(0.975f, -0.275f, 1.36f, -0.816f)
            curveToRelative(0.31f, -0.434f, 0.536f, -1.017f, 0.612f, -1.684f)
            close()
