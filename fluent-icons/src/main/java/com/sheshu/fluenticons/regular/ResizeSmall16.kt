...
public val FluentIcons.Regular.ResizeSmall16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ResizeSmall16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-1f)
            curveTo(6.672f, 10f, 6f, 9.328f, 6f, 8.5f)
            verticalLineToRelative(-1f)
            close()
            moveTo(7.5f, 7f)
            ...
            curveToRelative(0f, -0.276f, -0.224f, -0.5f, -0.5f, -0.5f)
            reflectiveCurveTo(2f, 9.974f, 2f, 10.25f)
            verticalLineToRelative(1.25f)
            curveTo(2f, 12.88f, 3.12f, 14f, 4.5f, 14f)
            horizontalLineToRelative(1.25f)
            curveToRelative(0.276f, 0f, 0.5f, -0.224f, 0.5f, -0.5f)
            reflectiveCurveTo(6.026f, 13f, 5.75f, 13f)
