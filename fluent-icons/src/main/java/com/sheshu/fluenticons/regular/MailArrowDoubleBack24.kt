...
public val FluentIcons.Regular.MailArrowDoubleBack24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MailArrowDoubleBack24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(20.5f, 8.276f, 20.5f, 8f)
            verticalLineTo(7.5f)
