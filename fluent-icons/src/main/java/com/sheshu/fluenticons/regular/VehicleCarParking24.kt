...
public val FluentIcons.Regular.VehicleCarParking24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.VehicleCarParking24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(15.8f, 3f)
            curveToRelative(0.152f, 0f, 0.302f, 0.01f, 0.45f, 0.031f)
