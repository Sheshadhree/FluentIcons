...
public val FluentIcons.Regular.Battery420: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Battery420",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.426f, 0f, 0.778f, 0.318f, 0.83f, 0.73f)
            lineTo(8f, 7.784f)
