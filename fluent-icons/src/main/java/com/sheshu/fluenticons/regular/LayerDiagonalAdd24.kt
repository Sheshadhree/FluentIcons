...
public val FluentIcons.Regular.LayerDiagonalAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.LayerDiagonalAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 1.56f, 1.549f, 2.647f, 3.016f, 2.116f)
            lineToRelative(0.507f, -0.184f)
            curveToRelative(-0.33f, -0.393f, -0.615f, -0.825f, -0.846f, -1.289f)
            lineToRelative(-0.172f, 0.062f)
            curveTo(12.016f, 20.631f, 11.5f, 20.27f, 11.5f, 19.75f)
            verticalLineToRelative(-6.783f)
            ...
            reflectiveCurveTo(13f, 14.462f, 13f, 17.5f)
