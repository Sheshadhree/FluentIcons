...
public val FluentIcons.Regular.TextBulletListTree24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextBulletListTree24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(6f, 19.439f, 6f, 18.749f)
            reflectiveCurveTo(6.56f, 17.5f, 7.25f, 17.5f)
            close()
            ...
            curveToRelative(0.69f, 0f, 1.249f, 0.56f, 1.249f, 1.25f)
            reflectiveCurveToRelative(-0.56f, 1.249f, -1.25f, 1.249f)
            reflectiveCurveTo(2f, 12.939f, 2f, 12.249f)
            reflectiveCurveTo(2.56f, 11f, 3.25f, 11f)
            close()
            moveToRelative(3.5f, 0.5f)
            ...
            curveToRelative(0.69f, 0f, 1.249f, 0.56f, 1.249f, 1.25f)
            reflectiveCurveToRelative(-0.56f, 1.249f, -1.25f, 1.249f)
            reflectiveCurveTo(2f, 6.439f, 2f, 5.749f)
