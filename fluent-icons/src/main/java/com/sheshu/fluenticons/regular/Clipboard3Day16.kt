...
public val FluentIcons.Regular.Clipboard3Day16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Clipboard3Day16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-4f)
            curveTo(7.5f, 6.224f, 7.724f, 6f, 8f, 6f)
