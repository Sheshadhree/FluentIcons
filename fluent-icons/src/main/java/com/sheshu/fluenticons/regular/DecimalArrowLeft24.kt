...
public val FluentIcons.Regular.DecimalArrowLeft24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DecimalArrowLeft24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(8.5f, 11.828f, 8.5f, 11f)
            verticalLineTo(7f)
            curveToRelative(0f, -0.828f, 0.672f, -1.5f, 1.5f, -1.5f)
            ...
            moveTo(19.5f, 7f)
            verticalLineToRelative(4f)
            curveToRelative(0f, 0.104f, -0.01f, 0.206f, -0.03f, 0.304f)
            curveToRelative(0.488f, 0.155f, 0.952f, 0.366f, 1.383f, 0.626f)
            curveTo(20.948f, 11.637f, 21f, 11.325f, 21f, 11f)
            verticalLineTo(7f)
            curveToRelative(0f, -1.657f, -1.343f, -3f, -3f, -3f)
            reflectiveCurveToRelative(-3f, 1.343f, -3f, 3f)
            verticalLineToRelative(4f)
            curveToRelative(0f, 0.164f, 0.013f, 0.325f, 0.039f, 0.482f)
            curveToRelative(0.463f, -0.19f, 0.953f, -0.327f, 1.463f, -0.406f)
            lineTo(16.5f, 11f)
            verticalLineTo(7f)
            curveToRelative(0f, -0.828f, 0.672f, -1.5f, 1.5f, -1.5f)
            reflectiveCurveToRelative(1.5f, 0.672f, 1.5f, 1.5f)
