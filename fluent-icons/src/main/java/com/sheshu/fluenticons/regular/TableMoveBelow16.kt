...
public val FluentIcons.Regular.TableMoveBelow16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableMoveBelow16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(5.602f, 8.775f, 5.794f, 8.657f, 6f, 8.584f)
            verticalLineTo(6f)
            horizontalLineToRelative(4f)
            verticalLineToRelative(2.585f)
            curveToRelative(0.205f, 0.073f, 0.397f, 0.19f, 0.56f, 0.354f)
            curveTo(10.855f, 9.232f, 11f, 9.616f, 11f, 10f)
            ...
            horizontalLineTo(5f)
            close()
            moveToRelative(1.146f, 6.646f)
            curveToRelative(0.196f, -0.195f, 0.512f, -0.195f, 0.708f, 0f)
            lineTo(7.5f, 10.293f)
            verticalLineTo(8.5f)
            curveTo(7.5f, 8.224f, 7.724f, 8f, 8f, 8f)
