...
public val FluentIcons.Regular.TableEdit28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableEdit28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.506f, -0.043f, -1.021f, 0.03f, -1.5f, 0.22f)
            verticalLineTo(11f)
