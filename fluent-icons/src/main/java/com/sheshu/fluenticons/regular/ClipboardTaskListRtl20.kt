...
public val FluentIcons.Regular.ClipboardTaskListRtl20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ClipboardTaskListRtl20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-3f)
            curveTo(7.847f, 5f, 7.291f, 4.583f, 7.085f, 4f)
            close()
        }
    }.build()
}
