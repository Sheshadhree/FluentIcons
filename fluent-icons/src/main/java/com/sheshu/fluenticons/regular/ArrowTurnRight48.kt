...
public val FluentIcons.Regular.ArrowTurnRight48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ArrowTurnRight48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(10f, 41.44f, 10f, 40.75f)
            ...
            curveTo(39.864f, 15.84f, 40f, 16.163f, 40f, 16.5f)
