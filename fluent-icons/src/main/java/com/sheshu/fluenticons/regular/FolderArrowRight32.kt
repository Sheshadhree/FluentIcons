...
public val FluentIcons.Regular.FolderArrowRight32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.FolderArrowRight32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-2.06f, -2.06f)
            curveTo(11.244f, 6.157f, 10.862f, 6f, 10.465f, 6f)
            ...
            reflectiveCurveTo(18.836f, 22f, 19.25f, 22f)
            close()
        }
    }.build()
}
