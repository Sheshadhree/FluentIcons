...
public val FluentIcons.Regular.TextColumnTwoLeft20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextColumnTwoLeft20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(-7f)
            curveTo(9.224f, 6f, 9f, 5.776f, 9f, 5.5f)
            close()
