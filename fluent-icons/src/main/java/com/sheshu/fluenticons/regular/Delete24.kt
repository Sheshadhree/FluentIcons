...
public val FluentIcons.Regular.Delete24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Delete24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(1.159f, 0f, 2.128f, -0.88f, 2.24f, -2.033f)
            lineTo(18.424f, 6.5f)
