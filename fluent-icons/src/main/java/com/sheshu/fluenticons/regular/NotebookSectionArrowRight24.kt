...
public val FluentIcons.Regular.NotebookSectionArrowRight24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.NotebookSectionArrowRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.523f, 0.08f, -1.026f, 0.224f, -1.5f, 0.421f)
            verticalLineTo(5.5f)
            ...
            curveToRelative(0.08f, 0.524f, 0.223f, 1.026f, 0.42f, 1.5f)
            horizontalLineTo(9.25f)
