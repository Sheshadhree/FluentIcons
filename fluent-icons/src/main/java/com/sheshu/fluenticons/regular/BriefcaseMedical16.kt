...
public val FluentIcons.Regular.BriefcaseMedical16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.BriefcaseMedical16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.276f, 0f, 0.5f, 0.224f, 0.5f, 0.5f)
            reflectiveCurveTo(10.276f, 9.5f, 10f, 9.5f)
            ...
            verticalLineTo(9.5f)
            horizontalLineTo(6f)
            curveTo(5.724f, 9.5f, 5.5f, 9.276f, 5.5f, 9f)
            reflectiveCurveTo(5.724f, 8.5f, 6f, 8.5f)
            horizontalLineToRelative(1.5f)
            verticalLineTo(7f)
            curveToRelative(0f, -0.276f, 0.224f, -0.5f, 0.5f, -0.5f)
            close()
