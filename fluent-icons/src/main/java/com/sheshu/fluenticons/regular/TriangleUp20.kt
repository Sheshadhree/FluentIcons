...
public val FluentIcons.Regular.TriangleUp20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TriangleUp20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-6.5f, 11.998f)
            curveTo(2.882f, 15.594f, 3.123f, 16f, 3.502f, 16f)
