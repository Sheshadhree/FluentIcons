...
public val FluentIcons.Regular.Flag28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Flag28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(16.392f)
            lineToRelative(-3.527f, 5.6f)
            curveToRelative(-0.153f, 0.245f, -0.153f, 0.555f, 0f, 0.8f)
            lineToRelative(3.527f, 5.6f)
