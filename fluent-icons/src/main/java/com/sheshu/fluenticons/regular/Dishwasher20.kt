...
public val FluentIcons.Regular.Dishwasher20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Dishwasher20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.426f, 16.236f, 6.764f, 16.574f, 6.915f, 17f)
            ...
            curveTo(10f, 5.224f, 10.224f, 5f, 10.5f, 5f)
            ...
            curveTo(5.776f, 18f, 6f, 17.776f, 6f, 17.5f)
