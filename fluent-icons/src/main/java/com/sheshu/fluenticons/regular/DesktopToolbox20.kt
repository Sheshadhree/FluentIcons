...
public val FluentIcons.Regular.DesktopToolbox20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DesktopToolbox20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.017f, 17.838f, 9f, 17.671f, 9f, 17.5f)
            verticalLineTo(17f)
            horizontalLineTo(8f)
            verticalLineToRelative(-2f)
