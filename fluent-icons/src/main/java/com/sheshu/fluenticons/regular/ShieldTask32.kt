...
public val FluentIcons.Regular.ShieldTask32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ShieldTask32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.715f, 21.916f, 5f, 19.12f, 5f, 16f)
            close()
            moveToRelative(17.707f, -3.293f)
