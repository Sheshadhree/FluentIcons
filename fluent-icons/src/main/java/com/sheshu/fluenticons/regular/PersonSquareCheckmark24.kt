...
public val FluentIcons.Regular.PersonSquareCheckmark24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PersonSquareCheckmark24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(11f, 17.5f)
            curveToRelative(0f, 0.144f, 0.005f, 0.288f, 0.014f, 0.43f)
