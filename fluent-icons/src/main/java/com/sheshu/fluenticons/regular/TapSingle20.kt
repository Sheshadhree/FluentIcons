...
public val FluentIcons.Regular.TapSingle20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TapSingle20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(10f, 7.224f, 10f, 7.5f)
            verticalLineTo(10f)
            curveToRelative(0f, 0.243f, 0.175f, 0.45f, 0.414f, 0.492f)
            lineToRelative(3.35f, 0.587f)
            curveToRelative(0.922f, 0.162f, 1.472f, 1.118f, 1.149f, 1.996f)
            lineToRelative(-0.984f, 2.67f)
            curveToRelative(-0.185f, 0.503f, -0.623f, 0.868f, -1.15f, 0.96f)
            lineToRelative(-1.517f, 0.264f)
            curveToRelative(-0.502f, 0.087f, -1.077f, -0.227f, -1.415f, -0.772f)
            curveToRelative(-0.7f, -1.128f, -2.094f, -2.62f, -4.649f, -3.098f)
            curveToRelative(0.08f, -0.128f, 0.17f, -0.227f, 0.266f, -0.305f)
            curveToRelative(0.203f, -0.165f, 0.464f, -0.263f, 0.777f, -0.297f)
            curveToRelative(0.643f, -0.07f, 1.419f, 0.142f, 2.036f, 0.45f)
            curveToRelative(0.155f, 0.078f, 0.339f, 0.07f, 0.486f, -0.022f)
            curveTo(8.91f, 12.835f, 9f, 12.673f, 9f, 12.5f)
