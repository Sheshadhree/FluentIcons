...
public val FluentIcons.Regular.FilterSync24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.FilterSync24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(23f, 10.538f, 23f, 7.5f)
            reflectiveCurveTo(20.538f, 2f, 17.5f, 2f)
            reflectiveCurveTo(12f, 4.462f, 12f, 7.5f)
            close()
            moveTo(20.5f, 4f)
            ...
            reflectiveCurveTo(14f, 10.776f, 14f, 10.5f)
            verticalLineToRelative(-2f)
            ...
            curveTo(19.533f, 10.517f, 18.572f, 11f, 17.5f, 11f)
            curveToRelative(-0.98f, 0f, -1.865f, -0.403f, -2.5f, -1.05f)
            close()
            moveTo(7.5f, 12.5f)
            horizontalLineToRelative(5.846f)
            curveToRelative(-0.514f, -0.428f, -0.962f, -0.934f, -1.324f, -1.5f)
            horizontalLineTo(7.5f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            reflectiveCurveTo(7.086f, 12.5f, 7.5f, 12.5f)
            close()
            moveToRelative(3.5f, -5f)
            curveToRelative(0f, -0.516f, 0.06f, -1.019f, 0.174f, -1.5f)
            horizontalLineTo(4.5f)
            curveTo(4.086f, 6f, 3.75f, 6.336f, 3.75f, 6.75f)
            reflectiveCurveTo(4.086f, 7.5f, 4.5f, 7.5f)
