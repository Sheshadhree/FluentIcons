...
public val FluentIcons.Regular.AlignCenterHorizontal24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AlignCenterHorizontal24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(5.5f, 6.336f, 5.836f, 6f, 6.25f, 6f)
            horizontalLineToRelative(2.5f)
