...
public val FluentIcons.Regular.Fax16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Fax16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.125f, 6.63f, 9.281f, 6.29f, 9.5f, 6f)
            horizontalLineTo(5f)
            verticalLineTo(3.5f)
            ...
            curveTo(11.162f, 5.017f, 11.329f, 5f, 11.5f, 5f)
            ...
            curveTo(10.672f, 6f, 10f, 6.672f, 10f, 7.5f)
            ...
            reflectiveCurveTo(5f, 8.224f, 5f, 8.5f)
            close()
            moveTo(4.5f, 11f)
            ...
            reflectiveCurveTo(6f, 10.224f, 6f, 10.5f)
