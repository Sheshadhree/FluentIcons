...
public val FluentIcons.Regular.AppsListDetail24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AppsListDetail24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(18.664f, 8f, 18.25f, 8f)
            horizontalLineToRelative(-7f)
            close()
            ...
            horizontalLineToRelative(7f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(18.664f, 17f, 18.25f, 17f)
            horizontalLineToRelative(-7f)
            close()
        }
    }.build()
