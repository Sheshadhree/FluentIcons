...
public val FluentIcons.Regular.CommentArrowLeft12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CommentArrowLeft12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.097f, 3.195f, 6.061f, 3.25f, 6.036f, 3.31f)
            curveTo(6.015f, 3.367f, 6f, 3.43f, 6f, 3.497f)
            ...
            lineTo(6.651f, 9f)
            horizontalLineTo(9f)
            curveToRelative(1.019f, 0f, 1.86f, -0.762f, 1.984f, -1.747f)
            curveTo(10.52f, 7.56f, 9.992f, 7.786f, 9.427f, 7.904f)
            curveTo(9.297f, 7.966f, 9.153f, 8f, 9f, 8f)
            horizontalLineTo(6.5f)
            curveTo(6.401f, 8f, 6.305f, 8.03f, 6.223f, 8.084f)
            lineTo(4f, 9.566f)
            verticalLineTo(8.5f)
