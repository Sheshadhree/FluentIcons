...
public val FluentIcons.Regular.Molecule16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Molecule16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(3.672f, 8f, 4.5f, 8f)
            reflectiveCurveTo(6f, 8.672f, 6f, 9.5f)
            reflectiveCurveTo(5.328f, 11f, 4.5f, 11f)
            close()
