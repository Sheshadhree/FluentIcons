...
public val FluentIcons.Regular.UsbPlug24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.UsbPlug24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-1.19f, 0f, -2.165f, -0.924f, -2.245f, -2.095f)
