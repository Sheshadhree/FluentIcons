...
public val FluentIcons.Regular.ReceiptSparkles16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ReceiptSparkles16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(8.32f, 5.328f, 8.18f, 5.25f, 8.032f, 5.2f)
            close()
            moveTo(4.5f, 8f)
