...
public val FluentIcons.Regular.Replay16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Replay16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(6f, 6.001f)
            curveToRelative(0f, -0.767f, 0.83f, -1.249f, 1.496f, -0.868f)
            lineToRelative(3.498f, 2f)
            curveToRelative(0.672f, 0.383f, 0.672f, 1.352f, 0f, 1.736f)
            lineToRelative(-3.498f, 1.999f)
            curveTo(6.83f, 11.248f, 6f, 10.768f, 6f, 9.999f)
            verticalLineTo(6.001f)
            close()
            moveToRelative(4.498f, 2f)
            lineTo(7f, 6f)
            verticalLineToRelative(4f)
            lineToRelative(3.498f, -1.998f)
            close()
        }
    }.build()
}
