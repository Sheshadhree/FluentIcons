...
public val FluentIcons.Regular.TextDirectionHorizontalRight24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextDirectionHorizontalRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(3.053f, 12.97f)
            lineToRelative(3.753f, -9.496f)
            curveTo(7.042f, 2.88f, 7.85f, 2.844f, 8.151f, 3.37f)
            ...
            lineTo(18.44f, 7f)
            horizontalLineToRelative(-5.69f)
            curveTo(12.336f, 7f, 12f, 7.336f, 12f, 7.75f)
            close()
            ...
            curveTo(3.336f, 16.5f, 3f, 16.836f, 3f, 17.25f)
            close()
        }
    }.build()
}
