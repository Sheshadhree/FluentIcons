...
public val FluentIcons.Regular.TextIndentDecreaseLtr24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextIndentDecreaseLtr24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(8.336f, 17.5f, 8f, 17.164f, 8f, 16.75f)
            ...
            reflectiveCurveTo(8.336f, 6f, 8.75f, 6f)
            horizontalLineToRelative(9f)
            close()
        }
    }.build()
