...
public val FluentIcons.Regular.Calendar12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Calendar12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(3.776f, 7f, 3.5f, 7f)
            close()
            moveTo(5f, 5.5f)
            ...
            reflectiveCurveTo(5.776f, 7f, 5.5f, 7f)
            close()
            moveTo(7f, 5.5f)
