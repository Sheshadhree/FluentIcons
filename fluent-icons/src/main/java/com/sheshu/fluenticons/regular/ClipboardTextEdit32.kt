...
public val FluentIcons.Regular.ClipboardTextEdit32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ClipboardTextEdit32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-1.983f, 2f)
            horizontalLineTo(11f)
            curveToRelative(-0.552f, 0f, -1f, -0.448f, -1f, -1f)
            close()
            moveToRelative(3.937f, 5f)
            ...
            curveToRelative(0.622f, -0.345f, 1.31f, -0.526f, 2f, -0.545f)
            verticalLineTo(7.5f)
            ...
            horizontalLineToRelative(5f)
            curveToRelative(0f, -0.206f, 0.027f, -0.416f, 0.082f, -0.63f)
            lineTo(13.937f, 28f)
            close()
            moveTo(13f, 4f)
            horizontalLineToRelative(6f)
            ...
            reflectiveCurveToRelative(0.448f, -1f, 1f, -1f)
            close()
            moveToRelative(16.144f, 16.924f)
