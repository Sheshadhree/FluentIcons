...
public val FluentIcons.Regular.DataBarVerticalAscending24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DataBarVerticalAscending24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(-0.749f, -0.335f, -0.749f, -0.75f)
            verticalLineTo(5.25f)
            curveToRelative(0f, -0.415f, 0.335f, -0.75f, 0.749f, -0.75f)
            close()
            moveToRelative(-6.5f, 4f)
            curveToRelative(0.414f, 0f, 0.75f, 0.335f, 0.75f, 0.75f)
            verticalLineToRelative(9.5f)
