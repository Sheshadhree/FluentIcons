...
public val FluentIcons.Regular.ShieldArrowRight20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ShieldArrowRight20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-1.985f, -0.337f, -3.853f, -1.03f, -5.6f, -2.081f)
            lineTo(10f, 3.097f)
            lineTo(9.6f, 3.346f)
            curveTo(7.852f, 4.396f, 5.984f, 5.09f, 4f, 5.428f)
            verticalLineTo(9.5f)
            curveToRelative(0f, 3.242f, 1.798f, 5.643f, 5.478f, 7.246f)
            curveToRelative(0.195f, 0.435f, 0.444f, 0.84f, 0.74f, 1.206f)
