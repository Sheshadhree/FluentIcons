...
public val FluentIcons.Regular.ShieldPerson20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ShieldPerson20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(9.5f)
            curveToRelative(0f, 3.392f, -1.968f, 5.863f, -6f, 7.463f)
            curveToRelative(-4.032f, -1.6f, -6f, -4.071f, -6f, -7.463f)
