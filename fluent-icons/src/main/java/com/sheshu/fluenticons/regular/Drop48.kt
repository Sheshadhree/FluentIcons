...
public val FluentIcons.Regular.Drop48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Drop48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(14.612f, 18.558f, 12f, 23.536f, 12f, 28.25f)
            curveToRelative(0f, 4.874f, 1.437f, 8.143f, 3.553f, 10.197f)
            curveTo(17.68f, 40.51f, 20.65f, 41.5f, 24f, 41.5f)
            curveToRelative(3.35f, 0f, 6.32f, -0.99f, 8.447f, -3.053f)
            curveTo(34.563f, 36.393f, 36f, 33.124f, 36f, 28.25f)
            curveToRelative(0f, -4.71f, -2.67f, -9.75f, -5.73f, -13.952f)
