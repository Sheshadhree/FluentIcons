...
public val FluentIcons.Regular.BookExclamationMark24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.BookExclamationMark24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(13f, 12.164f, 13f, 11.75f)
            verticalLineToRelative(-5f)
            curveTo(13f, 6.336f, 12.664f, 6f, 12.25f, 6f)
