...
public val FluentIcons.Regular.ContractDownLeft32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ContractDownLeft32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, -0.978f, -0.792f, -1.77f, -1.77f, -1.77f)
            horizontalLineTo(5f)
            close()
            moveToRelative(16.414f, -6f)
