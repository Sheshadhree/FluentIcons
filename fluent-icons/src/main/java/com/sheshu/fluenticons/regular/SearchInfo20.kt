...
public val FluentIcons.Regular.SearchInfo20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.SearchInfo20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(8f, 11.276f, 8f, 11f)
            verticalLineTo(8f)
            curveToRelative(0f, -0.276f, 0.224f, -0.5f, 0.5f, -0.5f)
            close()
            moveToRelative(0f, -1f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(8.914f, 5f, 8.5f, 5f)
            reflectiveCurveTo(7.75f, 5.336f, 7.75f, 5.75f)
            reflectiveCurveTo(8.086f, 6.5f, 8.5f, 6.5f)
            close()
        }
    }.build()
}
