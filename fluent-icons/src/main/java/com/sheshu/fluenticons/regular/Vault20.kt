...
public val FluentIcons.Regular.Vault20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Vault20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(13.723f, 11.016f)
            curveTo(13.9f, 10.718f, 14f, 10.371f, 14f, 10f)
            ...
            lineToRelative(-0.63f, 0.63f)
            curveTo(12.718f, 8.1f, 12.371f, 8f, 12f, 8f)
