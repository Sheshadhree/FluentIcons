...
public val FluentIcons.Regular.StarHalf16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.StarHalf16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(7.36f, 1.767f, 7.68f, 1.6f, 8f, 1.6f)
            curveToRelative(0.321f, 0f, 0.643f, 0.166f, 0.808f, 0.501f)
            ...
            close()
            moveTo(8f, 11.336f)
            curveToRelative(0.144f, 0f, 0.288f, 0.034f, 0.42f, 0.103f)
