...
public val FluentIcons.Regular.NotepadSparkle16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.NotepadSparkle16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.188f, 2.778f, 6.13f, 2.886f, 6.088f, 3f)
            ...
            curveTo(8f, 10.672f, 8.672f, 10f, 9.5f, 10f)
            horizontalLineToRelative(2.188f)
            curveToRelative(0.069f, 0.03f, 0.135f, 0.075f, 0.187f, 0.127f)
            curveToRelative(0.07f, 0.06f, 0.11f, 0.14f, 0.14f, 0.22f)
            lineToRelative(0.26f, 0.802f)
            curveToRelative(0.027f, 0.066f, 0.058f, 0.13f, 0.093f, 0.19f)
            lineToRelative(-3.222f, 3.222f)
            curveTo(8.867f, 14.842f, 8.484f, 15f, 8.086f, 15f)
            horizontalLineTo(4.5f)
            ...
            curveToRelative(0.034f, 0f, 0.067f, 0.003f, 0.099f, 0.01f)
            curveToRelative(-0.064f, 0.155f, -0.095f, 0.325f, -0.095f, 0.494f)
            curveToRelative(0f, 0.169f, 0.03f, 0.333f, 0.093f, 0.487f)
            curveTo(10.066f, 8.997f, 10.033f, 9f, 10f, 9f)
            horizontalLineTo(6f)
