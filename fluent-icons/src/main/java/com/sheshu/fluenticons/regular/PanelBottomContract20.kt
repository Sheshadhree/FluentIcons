...
public val FluentIcons.Regular.PanelBottomContract20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PanelBottomContract20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.061f, 0.176f, -0.157f, 0.344f, -0.287f, 0.493f)
            lineTo(12.435f, 12f)
            ...
            lineToRelative(-0.444f, -0.507f)
            curveToRelative(-0.13f, -0.15f, -0.226f, -0.317f, -0.287f, -0.493f)
            horizontalLineTo(3f)
            verticalLineTo(6f)
            close()
        }
