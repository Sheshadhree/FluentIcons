...
public val FluentIcons.Regular.Status20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Status20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-0.854f, 0.854f)
            curveTo(15.981f, 9.446f, 16f, 9.72f, 16f, 10f)
