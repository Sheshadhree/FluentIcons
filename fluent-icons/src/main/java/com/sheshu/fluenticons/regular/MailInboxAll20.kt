...
public val FluentIcons.Regular.MailInboxAll20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MailInboxAll20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(8f, 10.223f, 7.776f, 10f, 7.5f, 10f)
            horizontalLineTo(4f)
            verticalLineTo(6f)
