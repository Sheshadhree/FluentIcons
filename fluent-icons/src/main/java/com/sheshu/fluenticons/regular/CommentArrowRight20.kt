...
public val FluentIcons.Regular.CommentArrowRight20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CommentArrowRight20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(12.014f, 5.367f, 12f, 5.43f, 12f, 5.497f)
            ...
            curveTo(9.438f, 3.317f, 9.306f, 3.651f, 9.207f, 4f)
            horizontalLineTo(4.6f)
