...
public val FluentIcons.Regular.GlanceDefault12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.GlanceDefault12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(3.776f, 10f, 3.5f, 10f)
            horizontalLineToRelative(-1f)
            close()
        }
    }.build()
