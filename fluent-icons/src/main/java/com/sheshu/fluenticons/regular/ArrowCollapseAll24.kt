...
public val FluentIcons.Regular.ArrowCollapseAll24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ArrowCollapseAll24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(7.28f, 8.22f)
            curveTo(7.14f, 8.079f, 6.95f, 8f, 6.75f, 8f)
            reflectiveCurveTo(6.36f, 8.079f, 6.22f, 8.22f)
