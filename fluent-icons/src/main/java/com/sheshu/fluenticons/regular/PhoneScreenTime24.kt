...
public val FluentIcons.Regular.PhoneScreenTime24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PhoneScreenTime24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(11f, 17.499f)
            curveToRelative(0f, 0.517f, 0.06f, 1.02f, 0.174f, 1.5f)
