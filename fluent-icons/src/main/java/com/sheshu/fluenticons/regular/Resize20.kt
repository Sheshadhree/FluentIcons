...
public val FluentIcons.Regular.Resize20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Resize20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(4.787f, 15.887f, 4f, 15.036f, 4f, 14f)
            ...
            curveToRelative(0f, 1.105f, -0.895f, 2f, -2f, 2f)
            horizontalLineTo(6f)
            curveToRelative(-0.069f, 0f, -0.137f, -0.004f, -0.205f, -0.01f)
            close()
            moveTo(3f, 14f)
