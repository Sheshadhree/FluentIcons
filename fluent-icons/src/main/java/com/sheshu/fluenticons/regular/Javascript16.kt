...
public val FluentIcons.Regular.Javascript16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Javascript16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(8.5f, 7.5f)
            curveTo(8.5f, 6.672f, 9.172f, 6f, 10f, 6f)
            ...
            reflectiveCurveTo(8.724f, 11f, 9f, 11f)
            horizontalLineToRelative(1.5f)
            curveToRelative(0.276f, 0f, 0.5f, -0.224f, 0.5f, -0.5f)
            verticalLineTo(10f)
            curveToRelative(0f, -0.276f, -0.224f, -0.5f, -0.5f, -0.5f)
            horizontalLineTo(10f)
            curveTo(9.172f, 9.5f, 8.5f, 8.828f, 8.5f, 8f)
            verticalLineTo(7.5f)
            close()
            moveTo(8f, 6.5f)
            ...
            horizontalLineToRelative(1f)
            curveTo(7.328f, 12f, 8f, 11.328f, 8f, 10.5f)
            verticalLineToRelative(-4f)
            close()
