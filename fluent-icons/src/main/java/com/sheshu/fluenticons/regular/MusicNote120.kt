...
public val FluentIcons.Regular.MusicNote120: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MusicNote120",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(16f, 7.823f)
            lineToRelative(-5.5f, -1.692f)
            verticalLineTo(3.177f)
            lineToRelative(4.441f, 1.366f)
            curveTo(15.571f, 4.737f, 16f, 5.32f, 16f, 5.978f)
            verticalLineToRelative(1.846f)
            close()
            moveTo(5f, 14.75f)
            curveToRelative(0f, -1.243f, 1.007f, -2.25f, 2.25f, -2.25f)
            reflectiveCurveToRelative(2.25f, 1.007f, 2.25f, 2.25f)
            reflectiveCurveTo(8.493f, 17f, 7.25f, 17f)
            reflectiveCurveTo(5f, 15.993f, 5f, 14.75f)
            close()
        }
    }.build()
}
