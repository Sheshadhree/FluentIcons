...
public val FluentIcons.Regular.BookmarkSearch24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.BookmarkSearch24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(18.37f, 9.692f, 17.47f, 10f, 16.5f, 10f)
            curveTo(14.014f, 10f, 12f, 7.985f, 12f, 5.5f)
            reflectiveCurveTo(14.013f, 1f, 16.5f, 1f)
            curveTo(18.985f, 1f, 21f, 3.015f, 21f, 5.5f)
            curveToRelative(0f, 0.972f, -0.309f, 1.872f, -0.832f, 2.607f)
