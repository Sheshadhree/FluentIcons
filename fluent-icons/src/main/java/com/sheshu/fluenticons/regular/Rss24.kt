...
public val FluentIcons.Regular.Rss24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Rss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
