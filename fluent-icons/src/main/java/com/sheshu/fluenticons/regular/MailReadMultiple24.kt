...
public val FluentIcons.Regular.MailReadMultiple24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MailReadMultiple24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(2.318f, 6.382f, 2f, 6.917f, 2f, 7.5f)
            verticalLineToRelative(8.25f)
            curveTo(2f, 17.545f, 3.455f, 19f, 5.25f, 19f)
            horizontalLineToRelative(11.5f)
            curveToRelative(1.795f, 0f, 3.25f, -1.455f, 3.25f, -3.25f)
            verticalLineTo(7.5f)
            curveToRelative(0f, -0.583f, -0.318f, -1.119f, -0.83f, -1.398f)
            lineToRelative(-7.81f, -4.26f)
            close()
            moveTo(11f, 11.146f)
            lineTo(3.858f, 7.25f)
            lineTo(11f, 3.354f)
            lineToRelative(7.142f, 3.896f)
            lineTo(11f, 11.146f)
            close()
            moveToRelative(0.36f, 1.512f)
            lineToRelative(7.14f, -3.895f)
