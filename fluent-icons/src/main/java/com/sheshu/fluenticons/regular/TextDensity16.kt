...
public val FluentIcons.Regular.TextDensity16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextDensity16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(13.33f, 12f, 12.5f, 12f)
            close()
            ...
            verticalLineTo(4f)
            horizontalLineToRelative(2.5f)
            curveTo(13.33f, 4f, 14f, 4.672f, 14f, 5.5f)
            reflectiveCurveTo(13.33f, 7f, 12.5f, 7f)
            close()
        }
    }.build()
}
