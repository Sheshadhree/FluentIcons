...
public val FluentIcons.Regular.ProjectionScreenText24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ProjectionScreenText24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(14.164f, 8.5f, 13.75f, 8.5f)
            horizontalLineToRelative(-4f)
            ...
            horizontalLineToRelative(4f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(14.164f, 13f, 13.75f, 13f)
            horizontalLineToRelative(-4f)
            close()
            ...
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            reflectiveCurveTo(15.664f, 10f, 15.25f, 10f)
            horizontalLineToRelative(-6.5f)
            close()
            moveTo(2f, 4.5f)
            ...
            curveToRelative(0.414f, 0f, 0.75f, 0.336f, 0.75f, 0.75f)
            reflectiveCurveTo(16.664f, 21f, 16.25f, 21f)
