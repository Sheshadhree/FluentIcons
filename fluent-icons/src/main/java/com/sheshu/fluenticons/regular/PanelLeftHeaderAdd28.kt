...
public val FluentIcons.Regular.PanelLeftHeaderAdd28: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PanelLeftHeaderAdd28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.07f, 0.519f, 0.191f, 1.02f, 0.36f, 1.5f)
            horizontalLineTo(5.755f)
            curveToRelative(-2.071f, 0f, -3.75f, -1.679f, -3.75f, -3.75f)
            verticalLineTo(7.75f)
            close()
            moveToRelative(22.497f, 0f)
