...
public val FluentIcons.Regular.ReceiptMoney16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ReceiptMoney16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(3.75f)
            curveTo(12f, 2.784f, 11.216f, 2f, 10.25f, 2f)
            horizontalLineToRelative(-5.5f)
            close()
            moveTo(8.5f, 8f)
            curveToRelative(0.34f, 0f, 0.666f, 0.068f, 0.962f, 0.192f)
            curveTo(9.486f, 8.132f, 9.5f, 8.068f, 9.5f, 8f)
            curveToRelative(0f, -0.276f, -0.224f, -0.5f, -0.5f, -0.5f)
            horizontalLineTo(6f)
            curveTo(5.724f, 7.5f, 5.5f, 7.724f, 5.5f, 8f)
            horizontalLineToRelative(3f)
            close()
            ...
            curveTo(4.672f, 13.5f, 4f, 12.828f, 4f, 12f)
            close()
        }
    }.build()
}
