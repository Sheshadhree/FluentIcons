...
public val FluentIcons.Regular.DesktopArrowRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DesktopArrowRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(5.999f, 9.752f)
            verticalLineToRelative(-3.484f)
            curveToRelative(0.55f, -0.287f, 1.056f, -0.65f, 1.5f, -1.077f)
            verticalLineToRelative(4.56f)
            curveToRelative(0f, 1.192f, -0.925f, 2.167f, -2.096f, 2.246f)
            ...
            curveToRelative(-0.296f, 0.463f, -0.536f, 0.966f, -0.708f, 1.5f)
            horizontalLineTo(4.25f)
