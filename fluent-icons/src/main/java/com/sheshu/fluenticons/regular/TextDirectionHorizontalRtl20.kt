...
public val FluentIcons.Regular.TextDirectionHorizontalRtl20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextDirectionHorizontalRtl20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-3f, -8f)
            curveTo(13.895f, 3.13f, 13.708f, 3f, 13.5f, 3f)
            close()
