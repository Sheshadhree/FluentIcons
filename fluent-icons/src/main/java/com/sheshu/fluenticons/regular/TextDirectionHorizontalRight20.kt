...
public val FluentIcons.Regular.TextDirectionHorizontalRight20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextDirectionHorizontalRight20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(6.5f, 3f)
            curveToRelative(0.21f, 0f, 0.395f, 0.13f, 0.468f, 0.324f)
