...
public val FluentIcons.Regular.LaptopDismiss16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.LaptopDismiss16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.509f, 0f, -1.002f, -0.07f, -1.47f, -0.199f)
            curveTo(4.17f, 11.485f, 4.775f, 12f, 5.5f, 12f)
            horizontalLineToRelative(7f)
            curveToRelative(0.828f, 0f, 1.5f, -0.672f, 1.5f, -1.5f)
            verticalLineToRelative(-4f)
            curveTo(14f, 5.672f, 13.328f, 5f, 12.5f, 5f)
            horizontalLineToRelative(-1.522f)
            curveTo(10.992f, 5.165f, 11f, 5.332f, 11f, 5.5f)
