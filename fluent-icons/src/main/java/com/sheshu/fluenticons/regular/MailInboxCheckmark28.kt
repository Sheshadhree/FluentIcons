...
public val FluentIcons.Regular.MailInboxCheckmark28: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MailInboxCheckmark28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(23.09f, 1f, 19.5f, 1f)
            reflectiveCurveTo(13f, 3.91f, 13f, 7.5f)
            reflectiveCurveToRelative(2.91f, 6.5f, 6.5f, 6.5f)
            close()
            moveToRelative(3.854f, -8.646f)
