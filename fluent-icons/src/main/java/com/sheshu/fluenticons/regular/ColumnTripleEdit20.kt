...
public val FluentIcons.Regular.ColumnTripleEdit20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ColumnTripleEdit20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.445f, 16.103f, 9.459f, 16.051f, 9.475f, 16f)
            horizontalLineTo(9f)
            curveToRelative(-0.552f, 0f, -1f, -0.448f, -1f, -1f)
            verticalLineTo(5f)
            curveToRelative(0f, -0.552f, 0.448f, -1f, 1f, -1f)
            ...
            curveToRelative(0.337f, -0.015f, 0.676f, 0.028f, 1f, 0.13f)
            close()
            moveToRelative(-7.02f, 6.243f)
