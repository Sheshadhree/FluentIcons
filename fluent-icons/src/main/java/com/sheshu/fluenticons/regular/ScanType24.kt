...
public val FluentIcons.Regular.ScanType24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ScanType24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineTo(9f)
            curveToRelative(0f, 0.414f, -0.336f, 0.75f, -0.75f, 0.75f)
            reflectiveCurveTo(15.5f, 9.414f, 15.5f, 9f)
            verticalLineTo(8.5f)
            horizontalLineToRelative(-2.75f)
            verticalLineToRelative(7f)
            horizontalLineToRelative(1.5f)
            curveToRelative(0.414f, 0f, 0.75f, 0.336f, 0.75f, 0.75f)
            reflectiveCurveTo(14.664f, 17f, 14.25f, 17f)
            ...
            verticalLineTo(9f)
            curveToRelative(0f, 0.414f, -0.336f, 0.75f, -0.75f, 0.75f)
            reflectiveCurveTo(7f, 9.414f, 7f, 9f)
