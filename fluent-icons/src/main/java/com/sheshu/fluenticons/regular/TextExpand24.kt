...
public val FluentIcons.Regular.TextExpand24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextExpand24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.336f, 18f, 6f, 18.336f, 6f, 18.75f)
            curveToRelative(0f, 0.38f, 0.282f, 0.694f, 0.648f, 0.743f)
            lineTo(6.75f, 19.5f)
            close()
            ...
            reflectiveCurveTo(2f, 13.985f, 2f, 11.5f)
            reflectiveCurveTo(4.015f, 7f, 6.5f, 7f)
            reflectiveCurveTo(11f, 9.015f, 11f, 11.5f)
            close()
