...
public val FluentIcons.Regular.Delete16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Delete16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(9f, 11.776f, 9f, 11.5f)
            verticalLineToRelative(-5f)
            ...
            curveToRelative(0.75f, 0f, 1.385f, -0.554f, 1.487f, -1.297f)
            lineTo(12.427f, 4f)
