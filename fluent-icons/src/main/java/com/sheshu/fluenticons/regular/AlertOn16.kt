...
public val FluentIcons.Regular.AlertOn16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AlertOn16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(2.276f, 7f, 2f, 7f)
            horizontalLineTo(0.5f)
            curveTo(0.224f, 7f, 0f, 6.776f, 0f, 6.5f)
            close()
            moveTo(15.5f, 6f)
            ...
            curveToRelative(-0.276f, 0f, -0.5f, -0.224f, -0.5f, -0.5f)
            reflectiveCurveTo(13.724f, 6f, 14f, 6f)
