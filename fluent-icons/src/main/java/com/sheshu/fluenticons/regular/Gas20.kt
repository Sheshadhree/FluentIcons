...
public val FluentIcons.Regular.Gas20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Gas20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(11.084f, 2.223f)
            curveTo(11.177f, 2.083f, 11.333f, 2f, 11.5f, 2f)
