...
public val FluentIcons.Regular.GlanceHorizontalSparkles20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.GlanceHorizontalSparkles20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(9.5f, 3f)
            curveToRelative(0.195f, 0f, 0.382f, 0.037f, 0.553f, 0.105f)
            curveTo(10.018f, 3.23f, 10f, 3.361f, 10f, 3.496f)
            ...
            horizontalLineToRelative(-5f)
            curveTo(9.672f, 11f, 9f, 11.672f, 9f, 12.5f)
            verticalLineToRelative(3f)
            curveToRelative(0f, 0.828f, 0.672f, 1.5f, 1.5f, 1.5f)
            horizontalLineToRelative(5f)
            close()
            ...
            close()
            moveTo(5.5f, 17f)
            curveTo(6.328f, 17f, 7f, 16.328f, 7f, 15.5f)
            verticalLineToRelative(-3f)
            curveTo(7f, 11.672f, 6.328f, 11f, 5.5f, 11f)
            horizontalLineToRelative(-1f)
            curveTo(3.672f, 11f, 3f, 11.672f, 3f, 12.5f)
            verticalLineToRelative(3f)
