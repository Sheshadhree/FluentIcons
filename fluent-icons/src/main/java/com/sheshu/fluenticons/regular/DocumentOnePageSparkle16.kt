...
public val FluentIcons.Regular.DocumentOnePageSparkle16: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentOnePageSparkle16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(9.59f, 8.49f)
            curveTo(9.823f, 8.45f, 10f, 8.247f, 10f, 8f)
            ...
            close()
            moveToRelative(0.41f, 3f)
            curveToRelative(0f, 0.246f, -0.177f, 0.45f, -0.41f, 0.493f)
            lineTo(9.5f, 11.992f)
            horizontalLineToRelative(-3f)
