...
public val FluentIcons.Regular.LocationArrowRight48: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.LocationArrowRight48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(-1.943f, -1.619f)
            curveToRelative(2.149f, -2.53f, 3.443f, -5.8f, 3.443f, -9.381f)
            curveToRelative(0f, -8.008f, -6.492f, -14.5f, -14.5f, -14.5f)
            reflectiveCurveTo(9.5f, 12.992f, 9.5f, 21f)
