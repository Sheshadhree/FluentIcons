...
public val FluentIcons.Regular.PeopleSearch20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PeopleSearch20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(-3f, -1.343f, -3f, -3f)
            close()
            moveToRelative(7.865f, 10.797f)
            curveToRelative(-1.071f, 0.683f, -2.454f, 1.064f, -3.962f, 1.171f)
            curveToRelative(-0.073f, -0.192f, -0.187f, -0.373f, -0.342f, -0.529f)
            lineTo(10.12f, 17f)
            curveToRelative(1.685f, -0.016f, 3.16f, -0.379f, 4.206f, -1.046f)
            curveTo(15.377f, 15.283f, 16f, 14.31f, 16f, 13f)
            curveToRelative(0f, -0.552f, -0.448f, -1f, -1f, -1f)
            horizontalLineTo(8.744f)
            curveToRelative(-0.126f, -0.356f, -0.295f, -0.691f, -0.502f, -1f)
