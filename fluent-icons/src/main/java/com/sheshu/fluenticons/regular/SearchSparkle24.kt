...
public val FluentIcons.Regular.SearchSparkle24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.SearchSparkle24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveToRelative(-4.62f, 4.889f)
            curveToRelative(0.457f, -0.553f, 0.843f, -1.168f, 1.14f, -1.832f)
            curveToRelative(-0.13f, -0.257f, -0.221f, -0.549f, -0.309f, -0.826f)
            lineTo(16.98f, 12.4f)
            curveToRelative(-0.1f, -0.306f, -0.436f, -0.428f, -0.757f, -0.515f)
            curveTo(15.415f, 14.555f, 12.935f, 16.5f, 10f, 16.5f)
            curveToRelative(-3.59f, 0f, -6.5f, -2.91f, -6.5f, -6.5f)
            curveToRelative(0f, -3.359f, 2.547f, -6.122f, 5.815f, -6.464f)
            curveToRelative(0.183f, -0.241f, 0.436f, -0.43f, 0.735f, -0.537f)
            ...
            curveToRelative(1.94f, 0f, 3.717f, -0.69f, 5.102f, -1.838f)
