...
public val FluentIcons.Regular.Delete12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Delete12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(2f)
            curveToRelative(0f, 0.276f, -0.224f, 0.5f, -0.5f, 0.5f)
            reflectiveCurveTo(4.5f, 8.276f, 4.5f, 8f)
            verticalLineTo(6f)
            curveToRelative(0f, -0.276f, 0.224f, -0.5f, 0.5f, -0.5f)
            close()
            moveTo(3.38f, 9.085f)
            curveTo(3.426f, 9.603f, 3.859f, 10f, 4.378f, 10f)
            horizontalLineToRelative(3.246f)
            curveToRelative(0.52f, 0f, 0.952f, -0.397f, 0.996f, -0.915f)
            lineTo(9.055f, 4f)
