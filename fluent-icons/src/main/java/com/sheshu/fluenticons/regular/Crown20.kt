...
public val FluentIcons.Regular.Crown20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Crown20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, 0.723f, 0.512f, 1.327f, 1.193f, 1.468f)
            lineToRelative(1.692f, 8.04f)
            curveTo(4.007f, 16.585f, 4.517f, 17f, 5.11f, 17f)
            ...
            close()
            moveTo(10f, 5.313f)
            lineToRelative(2.602f, 3.346f)
            curveToRelative(0.439f, 0.564f, 1.215f, 0.74f, 1.855f, 0.42f)
            lineToRelative(2.34f, -1.17f)
            lineToRelative(-1.66f, 7.892f)
            curveTo(15.111f, 15.917f, 15.01f, 16f, 14.891f, 16f)
            horizontalLineTo(5.109f)
            curveToRelative(-0.119f, 0f, -0.22f, -0.083f, -0.245f, -0.198f)
            lineTo(3.203f, 7.91f)
            lineToRelative(2.34f, 1.17f)
            curveTo(6.183f, 9.4f, 6.96f, 9.225f, 7.398f, 8.66f)
            lineTo(10f, 5.314f)
            close()
        }
    }.build()
