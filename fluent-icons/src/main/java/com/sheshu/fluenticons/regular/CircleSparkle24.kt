...
public val FluentIcons.Regular.CircleSparkle24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CircleSparkle24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(12f, 22f)
            curveToRelative(4.835f, 0f, 8.868f, -3.431f, 9.798f, -7.99f)
            curveToRelative(-0.102f, 0.025f, -0.214f, 0.04f, -0.338f, 0.04f)
            curveToRelative(-0.536f, 0f, -0.857f, -0.268f, -1.077f, -0.635f)
            curveTo(19.709f, 17.436f, 16.213f, 20.5f, 12f, 20.5f)
            curveToRelative(-4.694f, 0f, -8.5f, -3.806f, -8.5f, -8.5f)
            reflectiveCurveTo(7.306f, 3.5f, 12f, 3.5f)
            curveToRelative(0.113f, 0f, 0.226f, 0.002f, 0.338f, 0.007f)
            curveToRelative(0.18f, -0.228f, 0.425f, -0.405f, 0.712f, -0.508f)
            lineToRelative(1.34f, -0.44f)
            curveToRelative(0.13f, -0.044f, 0.254f, -0.102f, 0.37f, -0.173f)
            curveTo(13.883f, 2.134f, 12.957f, 2f, 12f, 2f)
