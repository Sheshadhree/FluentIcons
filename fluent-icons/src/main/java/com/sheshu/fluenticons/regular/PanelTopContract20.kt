...
public val FluentIcons.Regular.PanelTopContract20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PanelTopContract20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(6.991f, 8.657f, 6.895f, 8.824f, 6.834f, 9f)
            horizontalLineTo(3f)
