...
public val FluentIcons.Regular.CommentArrowRight48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CommentArrowRight48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(28.925f, 2f, 35f, 2f)
            reflectiveCurveToRelative(11f, 4.925f, 11f, 11f)
            close()
            moveTo(33.707f, 7.293f)
            ...
            curveTo(14.057f, 44.71f, 12f, 43.644f, 12f, 41.82f)
            verticalLineTo(36f)
