...
public val FluentIcons.Regular.Clipboard3Day20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Clipboard3Day20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-6f)
            curveTo(12f, 8.224f, 12.224f, 8f, 12.5f, 8f)
            reflectiveCurveTo(13f, 8.224f, 13f, 8.5f)
            verticalLineToRelative(6f)
