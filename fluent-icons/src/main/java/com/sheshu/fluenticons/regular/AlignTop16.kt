...
public val FluentIcons.Regular.AlignTop16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AlignTop16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            horizontalLineToRelative(1.5f)
            curveTo(5.664f, 13f, 6f, 12.664f, 6f, 12.25f)
            verticalLineToRelative(-6.5f)
            curveTo(6f, 5.336f, 5.664f, 5f, 5.25f, 5f)
            horizontalLineToRelative(-1.5f)
            close()
            moveTo(9f, 5.75f)
