...
public val FluentIcons.Regular.DrawerPlay24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DrawerPlay24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(22f, 3.462f, 22f, 6.5f)
            close()
            moveToRelative(-7f, 2.115f)
            curveToRelative(0f, 0.389f, 0.424f, 0.629f, 0.757f, 0.429f)
            lineToRelative(3.528f, -2.117f)
            curveToRelative(0.324f, -0.194f, 0.324f, -0.663f, 0f, -0.858f)
            lineToRelative(-3.528f, -2.117f)
            curveTo(15.424f, 3.752f, 15f, 3.992f, 15f, 4.382f)
            verticalLineToRelative(4.233f)
            close()
            moveToRelative(6f, 2.575f)
            curveToRelative(-0.444f, 0.427f, -0.949f, 0.79f, -1.5f, 1.078f)
            verticalLineTo(14f)
            horizontalLineToRelative(-4.558f)
            curveToRelative(-0.382f, 0f, -0.692f, 0.31f, -0.692f, 0.692f)
            ...
            curveTo(10.488f, 9.03f, 10.3f, 8.528f, 10.174f, 8f)
            horizontalLineTo(4.5f)
