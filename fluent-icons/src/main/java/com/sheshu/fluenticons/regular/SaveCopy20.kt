...
public val FluentIcons.Regular.SaveCopy20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.SaveCopy20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(8.5f, 6.224f, 8.5f, 6.5f)
            ...
            horizontalLineToRelative(2f)
            verticalLineToRelative(2f)
            curveTo(8.5f, 11.776f, 8.724f, 12f, 9f, 12f)
            ...
            close()
            moveTo(7.5f, 18f)
            curveToRelative(-0.953f, 0f, -1.818f, -0.382f, -2.45f, -1f)
