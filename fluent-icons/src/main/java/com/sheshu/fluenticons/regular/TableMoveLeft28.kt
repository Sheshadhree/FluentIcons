...
public val FluentIcons.Regular.TableMoveLeft28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableMoveLeft28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(4.5f, 24.664f, 4.164f, 25f, 3.75f, 25f)
            close()
            moveToRelative(6.163f, -7.442f)
            curveToRelative(0.181f, -0.161f, 0.32f, -0.352f, 0.419f, -0.558f)
            horizontalLineTo(17f)
            verticalLineToRelative(-6f)
            horizontalLineToRelative(-6.668f)
            curveToRelative(-0.098f, -0.206f, -0.238f, -0.397f, -0.42f, -0.558f)
            curveToRelative(-0.127f, -0.113f, -0.266f, -0.204f, -0.412f, -0.274f)
            verticalLineTo(4f)
            ...
            curveToRelative(0.146f, -0.07f, 0.285f, -0.161f, 0.413f, -0.274f)
            close()
            moveTo(11f, 18.5f)
            ...
            verticalLineToRelative(-5f)
            close()
            moveToRelative(-7.69f, 7.748f)
            lineTo(8.42f, 13.25f)
            horizontalLineTo(12f)
            curveToRelative(0.414f, 0f, 0.75f, 0.336f, 0.75f, 0.75f)
            reflectiveCurveToRelative(-0.336f, 0.75f, -0.75f, 0.75f)
            horizontalLineTo(8.42f)
            lineToRelative(0.89f, 1.002f)
