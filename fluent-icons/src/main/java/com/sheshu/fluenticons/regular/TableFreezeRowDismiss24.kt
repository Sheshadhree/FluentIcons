...
public val FluentIcons.Regular.TableFreezeRowDismiss24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableFreezeRowDismiss24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.463f, -0.296f, -0.966f, -0.537f, -1.5f, -0.71f)
            verticalLineTo(10f)
            horizontalLineToRelative(-4f)
            verticalLineToRelative(1.315f)
            curveToRelative(-0.534f, 0.172f, -1.037f, 0.413f, -1.5f, 0.71f)
            verticalLineTo(10f)
            horizontalLineToRelative(-4f)
            verticalLineToRelative(4f)
            horizontalLineToRelative(2.024f)
            curveToRelative(-0.296f, 0.463f, -0.537f, 0.966f, -0.71f, 1.5f)
            horizontalLineTo(10f)
            verticalLineToRelative(4f)
            horizontalLineToRelative(1.315f)
            curveToRelative(0.172f, 0.534f, 0.413f, 1.037f, 0.71f, 1.5f)
