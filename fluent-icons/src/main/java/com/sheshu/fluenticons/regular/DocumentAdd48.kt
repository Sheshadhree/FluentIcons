...
public val FluentIcons.Regular.DocumentAdd48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentAdd48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, -0.597f, -0.237f, -1.169f, -0.659f, -1.59f)
            lineTo(27.177f, 4.658f)
            curveTo(26.755f, 4.237f, 26.183f, 4f, 25.586f, 4f)
            horizontalLineTo(12.25f)
            curveTo(9.903f, 4f, 8f, 5.903f, 8f, 8.25f)
            verticalLineToRelative(14.746f)
            curveToRelative(0.796f, -0.332f, 1.633f, -0.587f, 2.5f, -0.756f)
            verticalLineTo(8.25f)
            close()
            moveToRelative(24.982f, 8.25f)
            horizontalLineTo(27.75f)
            curveToRelative(-0.69f, 0f, -1.25f, -0.56f, -1.25f, -1.25f)
            verticalLineTo(7.518f)
            lineToRelative(8.982f, 8.982f)
            close()
            moveTo(24f, 35f)
