...
public val FluentIcons.Regular.DocumentTableCheckmark20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentTableCheckmark20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(7.5f, 9f)
            curveTo(7.257f, 9f, 7.027f, 9.058f, 6.824f, 9.16f)
            curveTo(7.635f, 9.362f, 8.376f, 9.743f, 9f, 10.258f)
            verticalLineTo(10f)
