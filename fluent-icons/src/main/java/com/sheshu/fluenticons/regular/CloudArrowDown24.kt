...
public val FluentIcons.Regular.CloudArrowDown24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CloudArrowDown24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(7.486f, 9.185f, 7.156f, 9.5f, 6.755f, 9.5f)
            ...
            curveToRelative(-0.47f, -0.732f, -1.083f, -1.364f, -1.8f, -1.856f)
