...
public val FluentIcons.Regular.FontDecrease20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.FontDecrease20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(10f, 4f)
            curveToRelative(0.203f, 0f, 0.386f, 0.123f, 0.463f, 0.31f)
            ...
            lineToRelative(4.5f, -11f)
            curveTo(9.614f, 4.123f, 9.797f, 4f, 10f, 4f)
            close()
            moveToRelative(-2.119f, 7f)
