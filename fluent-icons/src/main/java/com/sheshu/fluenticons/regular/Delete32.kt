...
public val FluentIcons.Regular.Delete32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Delete32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(9.388f, 25.34f)
            curveToRelative(0.174f, 1.516f, 1.456f, 2.66f, 2.98f, 2.66f)
            horizontalLineToRelative(7.263f)
            curveToRelative(1.525f, 0f, 2.808f, -1.144f, 2.98f, -2.66f)
            lineTo(24.48f, 9f)
            horizontalLineTo(7.521f)
            lineToRelative(1.867f, 16.34f)
            close()
            moveTo(13f, 12.5f)
            curveToRelative(0.552f, 0f, 1f, 0.448f, 1f, 1f)
