...
public val FluentIcons.Regular.TextAlignLeftRotate9024: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TextAlignLeftRotate9024",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(17.5f, 2.336f, 17.836f, 2f, 18.25f, 2f)
            close()
            moveToRelative(-13f, 0f)
            curveTo(5.664f, 2f, 6f, 2.336f, 6f, 2.75f)
            verticalLineToRelative(10.5f)
            curveTo(6f, 13.664f, 5.664f, 14f, 5.25f, 14f)
            reflectiveCurveTo(4.5f, 13.664f, 4.5f, 13.25f)
            verticalLineTo(2.75f)
