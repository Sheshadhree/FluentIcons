...
public val FluentIcons.Regular.DocumentBulletListArrowLeft16: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentBulletListArrowLeft16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(10.366f, 1.158f, 9.984f, 1f, 9.586f, 1f)
            horizontalLineTo(6f)
            close()
            moveToRelative(3.743f, 6f)
