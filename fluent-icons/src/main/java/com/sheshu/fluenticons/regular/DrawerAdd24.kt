...
public val FluentIcons.Regular.DrawerAdd24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DrawerAdd24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(11f, 3.462f, 11f, 6.5f)
            reflectiveCurveToRelative(2.462f, 5.5f, 5.5f, 5.5f)
            reflectiveCurveTo(22f, 9.538f, 22f, 6.5f)
            close()
            moveTo(17f, 7f)
            ...
            reflectiveCurveTo(13.22f, 6f, 13.496f, 6f)
            horizontalLineTo(16f)
            verticalLineTo(3.5f)
            curveTo(16f, 3.222f, 16.224f, 3f, 16.5f, 3f)
            reflectiveCurveTo(17f, 3.222f, 17f, 3.5f)
            verticalLineTo(6f)
            horizontalLineToRelative(2.497f)
            curveToRelative(0.276f, 0f, 0.5f, 0.224f, 0.5f, 0.5f)
            reflectiveCurveTo(19.772f, 7f, 19.496f, 7f)
            horizontalLineTo(17f)
            close()
            moveToRelative(4f, 4.19f)
