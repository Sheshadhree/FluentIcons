...
public val FluentIcons.Regular.TableAdd16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableAdd16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0f, -1.177f, 0.37f, -2.268f, 1f, -3.163f)
            verticalLineTo(6f)
            horizontalLineToRelative(1.337f)
            curveTo(8.232f, 5.37f, 9.323f, 5f, 10.5f, 5f)
