...
public val FluentIcons.Regular.KeyboardLayoutOneHandedLeft24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.KeyboardLayoutOneHandedLeft24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(10.414f, 14.5f, 10f, 14.5f)
            horizontalLineTo(6.5f)
            curveToRelative(-0.414f, 0f, -0.75f, 0.336f, -0.75f, 0.75f)
            reflectiveCurveTo(6.086f, 16f, 6.5f, 16f)
            close()
            moveToRelative(3.005f, -5f)
