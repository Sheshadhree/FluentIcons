...
public val FluentIcons.Regular.PersonAlertOff20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.PersonAlertOff20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.639f, 0f, 1.263f, -0.046f, 1.859f, -0.14f)
            curveToRelative(-0.388f, -0.18f, -0.663f, -0.52f, -0.787f, -0.909f)
            curveTo(9.726f, 16.984f, 9.368f, 17f, 9f, 17f)
            ...
            horizontalLineToRelative(6.873f)
            curveToRelative(-0.255f, -0.284f, -0.382f, -0.642f, -0.382f, -1f)
            horizontalLineTo(4.009f)
            close()
            moveToRelative(14.637f, 7.354f)
            lineTo(17.293f, 17f)
            horizontalLineToRelative(-5.79f)
            curveToRelative(-0.466f, 0f, -0.678f, -0.58f, -0.323f, -0.881f)
            lineTo(12.5f, 15f)
            verticalLineToRelative(-2f)
            curveToRelative(0f, -0.244f, 0.029f, -0.482f, 0.084f, -0.71f)
            lineToRelative(-0.938f, -0.936f)
            ...
            curveToRelative(-0.196f, 0.195f, -0.512f, 0.195f, -0.708f, 0f)
            close()
            moveTo(18.5f, 15.378f)
            lineToRelative(-4.788f, -4.788f)
            curveToRelative(0.5f, -0.37f, 1.118f, -0.59f, 1.787f, -0.59f)
