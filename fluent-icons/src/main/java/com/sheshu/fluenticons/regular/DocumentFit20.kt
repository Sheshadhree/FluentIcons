...
public val FluentIcons.Regular.DocumentFit20: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentFit20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(6f, 13.224f, 6f, 13.5f)
            verticalLineToRelative(1f)
