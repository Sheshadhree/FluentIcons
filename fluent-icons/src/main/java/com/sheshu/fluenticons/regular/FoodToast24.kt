...
public val FluentIcons.Regular.FoodToast24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.FoodToast24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(19.5f, 7.75f)
            curveToRelative(0f, 1.486f, -0.683f, 2.813f, -1.75f, 3.683f)
            verticalLineToRelative(7.317f)
            curveToRelative(0f, 0.263f, -0.045f, 0.515f, -0.128f, 0.75f)
            horizontalLineTo(18.5f)
            curveToRelative(0.414f, 0f, 0.75f, -0.336f, 0.75f, -0.75f)
            verticalLineToRelative(-8.095f)
            curveToRelative(0f, -0.206f, 0.085f, -0.403f, 0.234f, -0.545f)
            curveToRelative(0.627f, -0.593f, 1.016f, -1.43f, 1.016f, -2.36f)
            curveToRelative(0f, -1.39f, -0.873f, -2.577f, -2.101f, -3.041f)
