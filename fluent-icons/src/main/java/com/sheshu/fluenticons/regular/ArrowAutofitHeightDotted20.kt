...
public val FluentIcons.Regular.ArrowAutofitHeightDotted20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ArrowAutofitHeightDotted20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(14.5f, 3.11f)
            lineToRelative(-1.641f, 1.7f)
            curveToRelative(-0.192f, 0.198f, -0.509f, 0.203f, -0.707f, 0.012f)
