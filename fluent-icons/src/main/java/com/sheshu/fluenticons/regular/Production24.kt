...
public val FluentIcons.Regular.Production24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Production24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(7.828f, 14.5f, 7f, 14.5f)
            reflectiveCurveTo(5.5f, 15.172f, 5.5f, 16f)
