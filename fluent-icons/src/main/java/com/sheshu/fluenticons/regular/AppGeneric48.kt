...
public val FluentIcons.Regular.AppGeneric48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AppGeneric48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(25.25f, 20f)
            curveTo(24.56f, 20f, 24f, 20.56f, 24f, 21.25f)
            reflectiveCurveToRelative(0.56f, 1.25f, 1.25f, 1.25f)
            horizontalLineToRelative(9.5f)
            curveToRelative(0.69f, 0f, 1.25f, -0.56f, 1.25f, -1.25f)
            reflectiveCurveTo(35.44f, 20f, 34.75f, 20f)
            horizontalLineToRelative(-9.5f)
            close()
            moveTo(24f, 26.25f)
