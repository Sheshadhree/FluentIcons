...
public val FluentIcons.Regular.AlignDistributeRight16: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AlignDistributeRight16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(-7f)
            curveTo(5f, 4.224f, 4.776f, 4f, 4.5f, 4f)
            horizontalLineToRelative(-1f)
            ...
            curveTo(10.224f, 10f, 10f, 9.776f, 10f, 9.5f)
            verticalLineToRelative(-3f)
