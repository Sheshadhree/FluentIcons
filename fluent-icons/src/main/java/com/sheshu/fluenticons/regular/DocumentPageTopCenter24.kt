...
public val FluentIcons.Regular.DocumentPageTopCenter24: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DocumentPageTopCenter24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(13.018f, 12f)
            curveToRelative(-0.409f, -0.065f, -0.688f, -0.449f, -0.623f, -0.858f)
            lineToRelative(0.104f, -0.66f)
            horizontalLineToRelative(-1.48f)
            lineToRelative(-0.143f, 0.895f)
            curveToRelative(-0.064f, 0.409f, -0.449f, 0.688f, -0.858f, 0.623f)
            curveToRelative(-0.409f, -0.065f, -0.688f, -0.449f, -0.623f, -0.858f)
            lineToRelative(0.104f, -0.66f)
            ...
            curveToRelative(0.064f, -0.409f, 0.448f, -0.688f, 0.857f, -0.623f)
            curveToRelative(0.41f, 0.064f, 0.689f, 0.449f, 0.624f, 0.858f)
            lineTo(11.73f, 5.98f)
            horizontalLineToRelative(1.48f)
            lineToRelative(0.2f, -1.259f)
            curveToRelative(0.065f, -0.409f, 0.45f, -0.688f, 0.858f, -0.623f)
            curveToRelative(0.41f, 0.064f, 0.689f, 0.449f, 0.624f, 0.858f)
            lineTo(14.73f, 5.98f)
