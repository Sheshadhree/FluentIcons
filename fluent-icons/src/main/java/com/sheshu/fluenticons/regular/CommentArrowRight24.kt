...
public val FluentIcons.Regular.CommentArrowRight24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CommentArrowRight24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.297f, 0.463f, -0.537f, 0.967f, -0.71f, 1.5f)
            lineTo(5.25f, 4.5f)
