...
public val FluentIcons.Regular.TableCellCenterEdit20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableCellCenterEdit20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(9.446f, 16.103f, 9.46f, 16.051f, 9.476f, 16f)
            horizontalLineTo(8f)
            ...
            curveToRelative(0.32f, -0.137f, 0.659f, -0.213f, 1f, -0.229f)
            verticalLineTo(5.5f)
            close()
