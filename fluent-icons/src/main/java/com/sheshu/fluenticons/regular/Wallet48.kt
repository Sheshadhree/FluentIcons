...
public val FluentIcons.Regular.Wallet48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Wallet48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(32.25f, 26f)
            curveTo(31.56f, 26f, 31f, 26.56f, 31f, 27.25f)
            reflectiveCurveToRelative(0.56f, 1.25f, 1.25f, 1.25f)
            horizontalLineToRelative(4.5f)
            curveToRelative(0.69f, 0f, 1.25f, -0.56f, 1.25f, -1.25f)
            reflectiveCurveTo(37.44f, 26f, 36.75f, 26f)
            horizontalLineToRelative(-4.5f)
            close()
            moveTo(6f, 10f)
