...
public val FluentIcons.Regular.AlignTop28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.AlignTop28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(7.75f, 7.5f)
            curveTo(7.06f, 7.5f, 6.5f, 8.06f, 6.5f, 8.75f)
            verticalLineToRelative(13.5f)
