...
public val FluentIcons.Regular.DualScreenClosedAlert20: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.DualScreenClosedAlert20",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
        viewportWidth = 20f,
        viewportHeight = 20f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(13.838f, 11.983f, 13.67f, 12f, 13.5f, 12f)
            curveToRelative(-0.172f, 0f, -0.339f, -0.017f, -0.5f, -0.05f)
            verticalLineTo(15f)
            curveToRelative(0f, 0.552f, -0.448f, 1f, -1f, 1f)
            horizontalLineTo(6f)
            verticalLineTo(6f)
