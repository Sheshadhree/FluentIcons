...
public val FluentIcons.Regular.Voicemail32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Voicemail32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(14.805f, 14.588f, 15f, 15.271f, 15f, 16f)
            close()
            ...
            horizontalLineTo(5.25f)
            curveTo(4.56f, 26f, 4f, 25.44f, 4f, 24.75f)
            verticalLineTo(7.25f)
            close()
        }
    }.build()
