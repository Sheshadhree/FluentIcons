...
public val FluentIcons.Regular.Warning12: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Warning12",
        defaultWidth = 12.dp,
        defaultHeight = 12.dp,
        viewportWidth = 12f,
        viewportHeight = 12f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(5.5f, 4.5f)
            curveTo(5.5f, 4.224f, 5.724f, 4f, 6f, 4f)
            reflectiveCurveToRelative(0.5f, 0.224f, 0.5f, 0.5f)
            verticalLineToRelative(1f)
            curveTo(6.5f, 5.776f, 6.276f, 6f, 6f, 6f)
            reflectiveCurveTo(5.5f, 5.776f, 5.5f, 5.5f)
            verticalLineToRelative(-1f)
            close()
            moveTo(6f, 6.75f)
