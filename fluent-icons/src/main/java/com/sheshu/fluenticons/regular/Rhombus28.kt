...
public val FluentIcons.Regular.Rhombus28: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.Rhombus28",
        defaultWidth = 28.dp,
        defaultHeight = 28.dp,
        viewportWidth = 28f,
        viewportHeight = 28f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(9.357f, 5.5f)
            curveToRelative(-0.622f, 0f, -1.18f, 0.383f, -1.401f, 0.964f)
            lineToRelative(-5.354f, 14f)
            curveToRelative(-0.376f, 0.982f, 0.35f, 2.036f, 1.4f, 2.036f)
            horizontalLineToRelative(14.64f)
            curveToRelative(0.62f, 0f, 1.178f, -0.384f, 1.4f, -0.964f)
            lineToRelative(5.354f, -14f)
            curveToRelative(0.376f, -0.982f, -0.35f, -2.036f, -1.4f, -2.036f)
