...
public val FluentIcons.Regular.ArrowDownloadOff48: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ArrowDownloadOff48",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(29.875f, 31.643f)
            lineToRelative(11.991f, 11.99f)
            ...
            close()
            moveTo(25.25f, 6.25f)
            verticalLineToRelative(14.404f)
            lineToRelative(-2.5f, -2.5f)
            verticalLineTo(6.25f)
            curveTo(22.75f, 5.56f, 23.31f, 5f, 24f, 5f)
