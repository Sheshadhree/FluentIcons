...
public val FluentIcons.Regular.FolderArrowLeft32: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.FolderArrowLeft32",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
        viewportWidth = 32f,
        viewportHeight = 32f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveTo(29.164f, 24f, 28.75f, 24f)
            close()
        }
    }.build()
}
