...
public val FluentIcons.Regular.TableSearch24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.TableSearch24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.098f, -0.53f, -0.272f, -1.034f, -0.51f, -1.5f)
            horizontalLineTo(14f)
            verticalLineToRelative(-4f)
            horizontalLineToRelative(-4f)
            verticalLineToRelative(3.337f)
            curveToRelative(-0.403f, -0.572f, -0.913f, -1.065f, -1.5f, -1.447f)
            verticalLineTo(10f)
            horizontalLineToRelative(-4f)
            verticalLineToRelative(1.09f)
            curveTo(3.97f, 11.189f, 3.466f, 11.363f, 3f, 11.6f)
