...
public val FluentIcons.Regular.MailInboxCheckmark16: ImageVector by
        lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.MailInboxCheckmark16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(5.838f, 11.919f, 6.71f, 12.5f, 8f, 12.5f)
            curveToRelative(1.279f, 0f, 2.147f, -0.571f, 2.622f, -1.501f)
            close()
        }
    }.build()
}
