...
public val FluentIcons.Regular.CalendarPhone16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.CalendarPhone16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(13.762f, 6.036f, 13.51f, 6f, 13.25f, 6f)
            horizontalLineTo(3f)
